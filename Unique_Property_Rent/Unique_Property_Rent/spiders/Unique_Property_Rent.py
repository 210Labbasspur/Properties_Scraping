...
class Unique_Property_Rent(scrapy.Spider):
    name = 'Unique_Property_Rent'
    prefix = 'https://www.unique-property.com'
    url = "https://www.unique-property.com/renting/properties-for-lease/"
    headers = {
    ...
    count = 1
    db = 'Unique_Property'
    collection = 'Unique_Property_Rent'
    bucket_prefix = 'D_Unique_Property_Rent'
