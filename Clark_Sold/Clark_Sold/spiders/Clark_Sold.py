...
class Clark_Sold(scrapy.Spider):
    name = 'Clark_Sold'
    prefix = 'https://clarkea.com.au'
    url = "https://clarkea.com.au/wp-json/api/listings/all?priceRange=&type=property&status=sold&paged={}&limit=16&address=&bed=&bath=&car=&sort="
    headers = {
        'accept': '*/*',
