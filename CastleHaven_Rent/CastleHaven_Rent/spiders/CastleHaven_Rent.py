...
class CastleHaven_Rent(scrapy.Spider):
    name = 'CastleHaven_Rent'
    prefix = 'https://www.castlehaven.com.au'
    url = "https://www.castlehaven.com.au/renting/properties-for-lease/"
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'cache-control': 'max-age=0',
        # 'cookie': '_ga=GA1.3.355024872.1712699930; _gid=GA1.3.518672099.1712699930; _gat=1; _gcl_au=1.1.1055607055.1712699930; _ga_B7K7T9T8YE=GS1.3.1712699931.1.1.1712699954.0.0.0; arp_scroll_position=3100',
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field6'] = response.xpath("//i[contains(@class,'la-bed')]/following-sibling::span[1]/text()").get('').strip()
            item['Field7'] = response.xpath("//i[contains(@class,'la-bath')]/following-sibling::span[1]/text()").get('').strip()
            item['Field8'] = response.xpath("//i[contains(@class,'la-car')]/following-sibling::span[1]/text()").get('').strip()
