...
class Fresh_Rent(scrapy.Spider):
    name = 'Fresh_Rent'
    prefix = 'https://listing.freshpropertyagents.com.au'
    url = "https://listing.freshpropertyagents.com.au/?action=epl_search&post_type=rental&property_status=current"
    headers = {
