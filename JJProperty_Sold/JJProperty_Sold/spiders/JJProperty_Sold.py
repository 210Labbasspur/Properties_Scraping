...
class JJProperty_Sold(scrapy.Spider):
    name = "JJProperty_Sold"

    url = "https://www.jjproperty.com.au/pages/real-estate/results?widgetKey=266319&context=listings&returnAs=markup&listing_sale_method=sale&display_sale_method=SOLD&status=sold&pg=1"
    ...
    def __init__(self, *args, **kwargs):
        super(JJProperty_Sold, self).__init__(*args, **kwargs)
        self.links = []
