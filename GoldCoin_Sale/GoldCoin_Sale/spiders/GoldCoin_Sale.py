...
class GoldCoin_Sale(scrapy.Spider):
    name = "GoldCoin_Sale"
    url = 'https://www.goldcoinrealestate.com.au/pages/real-estate/results?widgetKey=134300&context=listings&returnAs=markup&listing_sale_method=Sale&display_sale_method=BUY&pg=1'
    ...
    def __init__(self, *args, **kwargs):
        super(GoldCoin_Sale, self).__init__(*args, **kwargs)
        self.links = []
