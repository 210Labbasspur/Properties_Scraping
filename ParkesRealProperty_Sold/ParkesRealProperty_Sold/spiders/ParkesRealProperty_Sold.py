...
class ParkesRealProperty_Sold(scrapy.Spider):
    name = 'ParkesRealProperty_Sold'
    prefix = 'https://www.parkesrealproperty.com.au'
    url = "https://www.parkesrealproperty.com.au/recent-sales/"
    headers = {
    ...
    count = 1
    db = 'ParkesRealProperty'
    collection = 'ParkesRealProperty_Sold'
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Parkes Real Property'
            ...
            Agent_Imagess = response.css(".gallery-icon a ::attr(href)").getall()
            new_img_urls = []
            ...
            '''          AGENTS          '''
            if response.css("#epl-box2 .epl-author-box-outer-wrapper"):
                agent1 = response.css("#epl-box2 .epl-author-box-outer-wrapper")[0]
                ...
                if agent1_name:
                    ...
                    item['Field18'] = agent1.css(".position ::text").get('').strip()  # agent_full_name_1
                ...
                if len(response.css("#epl-box2 .epl-author-box-outer-wrapper").getall()) > 1:
                    agent2 = response.css("#epl-box2 .epl-author-box-outer-wrapper")[1]
                    agent2_name = agent2.css('h5 a ::text').get('').strip()
                    if agent2:
                        item['Field23'] = agent2_name.strip()
                        item['Field24'] = agent2.css(".position ::text").get('').strip()  # agent_full_name_1
                ...
                if len(response.css("#epl-box2 .epl-author-box-outer-wrapper").getall()) > 2:
                    agent3 = response.css("#epl-box2 .epl-author-box-outer-wrapper")[2]
                    agent3_name = agent3.css('h5 a ::text').get('').strip()
                    if agent3:
                        item['Field28'] = agent3_name.strip()
                        item['Field29'] = agent3.css(".position ::text").get('').strip()  # agent_full_name_1
            ...
            land_area = ''.join(e.strip() for e in response.css(".land-size ::text").getall())
            if land_area:
                item['Field36'] = land_area.replace('m²','').replace('Land is','').replace(',','').replace(' ','')   # land_area
