...
class RainbowBay_Sale(scrapy.Spider):
    name = "RainbowBay_Sale"

    url = 'https://www.rainbowbayrealty.com.au/buy/residential-properties'
    ...
    def __init__(self, *args, **kwargs):
        super(RainbowBay_Sale, self).__init__(*args, **kwargs)
        self.links = []
