...
class OnePercent_Sale(scrapy.Spider):
    name = "OnePercent_Sale"

    url = "https://onepercent.com.au/for-sale-2/"
    ...
    def __init__(self, *args, **kwargs):
        super(OnePercent_Sale, self).__init__(*args, **kwargs)
        self.links = []
