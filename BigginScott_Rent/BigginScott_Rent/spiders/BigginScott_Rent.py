...
class BigginScott_Rent(scrapy.Spider):
    name = "BigginScott_Rent"

    url = 'https://bigginscott.com.au/propertiesJson?callback=angular.callbacks._2&currentPage={}&perPage=96&sort=d_listing%20desc&listing_cat0=rental'
    ...
    def __init__(self, *args, **kwargs):
        super(BigginScott_Rent, self).__init__(*args, **kwargs)
        self.links = []
