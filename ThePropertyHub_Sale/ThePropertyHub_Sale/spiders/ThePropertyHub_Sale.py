...
class ThePropertyHub_Sale(scrapy.Spider):
    name = "ThePropertyHub_Sale"

    url = "https://www.thepropertyhub.com.au/for-sale/"
    ...
    count = 1
    db = 'ThePropertyHub'
    collection = 'ThePropertyHub_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(ThePropertyHub_Sale, self).__init__(*args, **kwargs)
        self.links = []
