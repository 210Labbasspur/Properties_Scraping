...
import requests, json, time, threading, queue, os, re
import boto3
from botocore.exceptions import NoCredentialsError, ClientError

class KyogleRE_Rent(scrapy.Spider):
    name = 'KyogleRE_Rent'
    prefix = 'https://www.kyoglerealestate.com'
    # url = "https://www.kyoglerealestate.com/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat0=residential&categories0=House&categories1=Unit&categories2=Townhouse&categories3=Villa&categories4=Apartment&categories5=Flat&categories6=DuplexSemi-detached&categories7=Alpine&categories8=AcreageSemi-rural&categories9=BlockOfUnits&categories10=Terrace&categories11=ServicedApartment&categories12=HomeDesign&categories13=HouseAndLandPackage"
    # url = "https://www.greencliff.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=rental"
    url = "https://www.kyoglerealestate.com/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=rental"
    ...
    def Detail_parse(self, mini_data,full_data):
        DB_already_exists = self.read_data_base(self.prefix + full_data['fields']['link'])
        if not DB_already_exists:
            ...
            item['Field4'] = 'Kyogle Real Estate'
            ...
            if full_data.get('fields').get('consultants'):
                ...
                if agent1:
                    ...
                    '''         Uploading Images on Wasabi S3 Bucket            '''
                    Agent_Images = agent1.get("imgSrc")
                ...
                if len(full_data.get('fields').get('consultants')) > 1:
                    ...
                    if agent2:
                        ...
                        '''         Uploading Images on Wasabi S3 Bucket            '''
                        Agent_Images = agent2.get("imgSrc")
                ...
                if len(full_data.get('fields').get('consultants')) == 3:
                    ...
                    if agent3:
                        ...
                        '''         Uploading Images on Wasabi S3 Bucket            '''
                        Agent_Images = agent3.get("imgSrc")
            ...
            item['Field36'] = full_data.get('fields').get('land_area_m2')
