...
class CoreRealty_Sold(scrapy.Spider):
    name = "CoreRealty_Sold"

    url = "https://corerealty.com.au/sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(CoreRealty_Sold, self).__init__(*args, **kwargs)
        self.links = []
