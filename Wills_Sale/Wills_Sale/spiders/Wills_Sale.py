...
class Wills_Sale(scrapy.Spider):
    name = 'Wills_Sale'
    prefix = 'https://www.willsproperty.com.au'
    url = "https://www.willsproperty.com.au/buy/"
    headers = {
    ...
    def parse(self, response):
        for property in response.css(".properties__items .properties__item a"):
