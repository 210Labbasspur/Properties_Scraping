...
class Bellarine_Rent(scrapy.Spider):
    name = "Bellarine_Rent"

    url = "https://www.bellarineproperty.com.au/properties-for-lease/"
    ...
    def __init__(self, *args, **kwargs):
        super(Bellarine_Rent, self).__init__(*args, **kwargs)
        self.links = []
