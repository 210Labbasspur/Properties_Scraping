...
class Drummond_Rent(scrapy.Spider):
    name = 'Drummond_Rent'
    prefix = 'https://jurds.com.au'
    # url = ("https://www.drummondrealestate.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bcount%5D%5Bvalue%5D=20&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Bmeta_key%5D%5Bvalue%5D=saleDate&query%5Bsold%5D%5Bvalue%5D=1&query%5Bsold%5D%5Btype%5D="
    #        "equal&query%5BsaleOrRental%5D%5Bvalue%5D=Rent&query%5BsaleOrRental%5D%5Btype%5D=equal&query%5Bpaged%5D%5Bvalue%5D=1")
    url = ("https://www.drummondrealestate.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bcount%5D%5Bvalue%5D=20&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Bmeta_key%5D%5Bvalue%5D=saleDate&query%5Bsold%5D%5Bvalue%5D=1&query%5Bsold%5D%5Btype%5D="
           "equal&query%5BsaleOrRental%5D%5Bvalue%5D=Rent&query%5BsaleOrRental%5D%5Btype%5D=equal&query%5Bpaged%5D%5Bvalue%5D={}")
    headers = {
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'content-length': '0',
        # 'cookie': '_gcl_au=1.1.2043263236.1713442603; _gid=GA1.3.1407017808.1713442604; _ga=GA1.4.679122247.1713442604; _gid=GA1.4.1407017808.1713442604; __eventn_id=siadmgxjov; _gat=1; _gat_clientTracker=1; _ga=GA1.1.679122247.1713442604; _ga_LJ3QB6FX5S=GS1.1.1713515409.2.1.1713515778.0.0.0; _ga_67P859NBLX=GS1.3.1713515409.2.1.1713515778.25.0.0; _ga_MQH0VX84FF=GS1.4.1713515410.2.1.1713515779.0.0.0',
        'origin': 'https://www.drummondrealestate.com.au',
        'priority': 'u=1, i',
        # 'referer': 'https://www.drummondrealestate.com.au/listings/?saleOrRental=Sale&sold=1',
    ...
    def parse(self, response):
        ...
        for property in data['data']['listings']:
            ...
            # mini_data['sold_price'] = property.get('price')
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Drummond Real Estate'
