...
class Clark_Rent(scrapy.Spider):
    name = 'Clark_Rent'
    prefix = 'https://clarkea.com.au'
    url = "https://clarkea.com.au/wp-json/api/listings/all?priceRange=&type=rental&status=current&paged={}&limit=16&address=&bed=&bath=&car=&sort="
    headers = {
        'accept': '*/*',
