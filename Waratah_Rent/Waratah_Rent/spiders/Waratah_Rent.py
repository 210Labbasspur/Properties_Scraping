...
class Waratah_Rent(scrapy.Spider):
    name = "Waratah_Rent"

    url = "https://www.waratahestateagents.com.au/properties-for-lease/"
    prefix = "https://www.waratahestateagents.com.au"
    headers = {
    ...
    count = 1
    db = 'Waratah'
    collection = 'Waratah_Rent'
    bucket_prefix = f'WEA_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(Waratah_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2931)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Waratah Estate Agents'
