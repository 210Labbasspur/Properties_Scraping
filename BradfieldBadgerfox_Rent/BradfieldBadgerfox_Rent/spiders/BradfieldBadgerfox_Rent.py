...
class BradfieldBadgerfox_Rent(scrapy.Spider):
    name = 'BradfieldBadgerfox_Rent'
    prefix = 'https://www.bradfieldbadgerfox.com.au'
    url = "https://www.bradfieldbadgerfox.com.au/residential-for-lease"
    headers = {
    ...
    collection = 'BradfieldBadgerfox_Rent'
