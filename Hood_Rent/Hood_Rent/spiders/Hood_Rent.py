...
class Hood_Rent(scrapy.Spider):
    name = "Hood_Rent"

    url = "https://hoodestateagents.com.au/ajaxPublish?_s_=Results&_f_=ForRent-Search-V2&n=9&page={}"
    ...
    def __init__(self, *args, **kwargs):
        super(Hood_Rent, self).__init__(*args, **kwargs)
        self.links = []
