...
class Higgins_Sold(scrapy.Spider):
    name = "Higgins_Sold"
    url = ('https://higginsrealestatelismore.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bcount%5D%5Bvalue%5D=20&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Bmeta_key%5D%5Bvalue%5D=saleDate&query%5Bsold%5D%5Bvalue%5D=1&query%5Bsold%5D%5Btype%5D=equal&query%5BsaleOrRental%5D%5Bvalue%5D=Sale&query%5BsaleOrRental%5D%5Btype%5D=equal&query'
    ...
    def __init__(self, *args, **kwargs):
        super(Higgins_Sold, self).__init__(*args, **kwargs)
        self.links = []
