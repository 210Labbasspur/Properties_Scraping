...
class RealWay_Rent(scrapy.Spider):
    name = "RealWay_Rent"
    url = "https://toowoomba.realway.com.au/listings?saleOrRental=Rental&status=available&sortby=dateListed-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(RealWay_Rent, self).__init__(*args, **kwargs)
        self.links = []
