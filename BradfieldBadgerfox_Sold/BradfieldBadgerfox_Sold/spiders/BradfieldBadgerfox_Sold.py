...
class BradfieldBadgerfox_Sold(scrapy.Spider):
    name = 'BradfieldBadgerfox_Sold'
    prefix = 'https://www.bradfieldbadgerfox.com.au'
    url = "https://www.bradfieldbadgerfox.com.au/sold-properties"
    headers = {
    ...
    collection = 'BradfieldBadgerfox_Sold'
