...
class River_Sold(scrapy.Spider):
    name = 'River_Sold'
    prefix = 'https://presence.realestate'
    # url = "https://www.riverrealty.com.au/wp-json/api/listings/all?priceRange=&category=&type=property&status=sold&paged=1&limit=20&address=&bed=&bath=&car=&sort="
    url = "https://www.riverrealty.com.au/wp-json/api/listings/all?priceRange=&category=&type=property&status=sold&paged={}&limit=20&address=&bed=&bath=&car=&sort="
    headers = {
