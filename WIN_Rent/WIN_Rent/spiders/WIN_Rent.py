...
class WIN_Rent(scrapy.Spider):
    name = "WIN_Rent"
    url = 'https://www.winrealestate.com.au/wp-json/api/listings/all?priceRange=&limit=12&type=rental&status=current&paged={}&bed=&bath=&car=&sort=newest'
    ...
    def __init__(self, *args, **kwargs):
        super(WIN_Rent, self).__init__(*args, **kwargs)
        self.links = []
