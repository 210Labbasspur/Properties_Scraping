...
class Nitschke_Sale(scrapy.Spider):
    name = "Nitschke_Sale"

    url = "https://www.nitschke.com.au/properties-for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(Nitschke_Sale, self).__init__(*args, **kwargs)
        self.links = []
