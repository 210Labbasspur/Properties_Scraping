...
class HayesWinckle_Sale(scrapy.Spider):
    name = "HayesWinckle_Sale"
    url = 'https://www.hayeswinckle.com.au/wp-admin/admin-ajax.php'
    prefix = "https://www.hayeswinckle.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(HayesWinckle_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2989)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Hayes Winckle'
