...
class Milestone_Rent(scrapy.Spider):
    name = "Milestone_Rent"

    url = "https://www.milestonere.com.au/browse-rental/"
    ...
    def __init__(self, *args, **kwargs):
        super(Milestone_Rent, self).__init__(*args, **kwargs)
        self.links = []
