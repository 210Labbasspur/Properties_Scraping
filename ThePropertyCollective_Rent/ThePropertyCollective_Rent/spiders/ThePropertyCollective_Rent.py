...
class ThePropertyCollective_Rent(scrapy.Spider):
    name = "ThePropertyCollective_Rent"

    url = "https://www.thepropertycollective.com.au/rent"
    ...
    collection = 'ThePropertyCollective_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(ThePropertyCollective_Rent, self).__init__(*args, **kwargs)
        self.links = []
