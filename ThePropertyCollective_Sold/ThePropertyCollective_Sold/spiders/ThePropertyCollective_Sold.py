...
class ThePropertyCollective_Sold(scrapy.Spider):
    name = "ThePropertyCollective_Sold"

    url = "https://www.thepropertycollective.com.au/sell"
    ...
    collection = 'ThePropertyCollective_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(ThePropertyCollective_Sold, self).__init__(*args, **kwargs)
        self.links = []
