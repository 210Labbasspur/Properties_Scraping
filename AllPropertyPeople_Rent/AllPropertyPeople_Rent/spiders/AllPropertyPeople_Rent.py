...
class AllPropertyPeople_Rent(scrapy.Spider):
    name = 'AllPropertyPeople_Rent'
    prefix = 'https://bollerco.com.au'
    url = ("https://www.allpropertypeople.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bpost_type%5D%5Btype%5D=equal&query%5Bcount%5D%5Bvalue%5D=20&query%5Bcount%5D%5Btype%5D=equal&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Borderby%5D%5Btype%5D=equal&query%5Bmeta_key%5D%5Bvalue%5D=dateListed&query%5Bmeta_key%5D%5Btype%5D=equal&query%5Bsold%5D%5Bvalue%5D=0&query%5Bsold%5D%5Btype%5D=equal&query%5BsaleOrRental%5D%5Bvalue%5D=Rental&query%5BsaleOrRental%5D%5Btype%5D=equal&"
           "query%5Bpaged%5D%5Bvalue%5D={}&query%5Bpaged%5D%5Btype%5D=equal&query%5Bextended%5D%5Bvalue%5D=1&query%5Border%5D%5Bvalue%5D=&query%5Border%5D%5Btype%5D=equal&query%5Bminprice%5D%5Bvalue%5D=&query%5Bmaxprice%5D%5Bvalue%5D=&query%5Bminbeds%5D%5Bvalue%5D=&query%5Bmaxbeds%5D%5Bvalue%5D=&query%5Bminbaths%5D%5Bvalue%5D=&query%5Bmaxbaths%5D%5Bvalue%5D=&query%5Bcars%5D%5Bvalue%5D=&query%5Btype%5D%5Bvalue%5D=&query%5Bsubcategory%5D%5Bvalue%5D=&query%5BexternalID%5D%5Bvalue%5D=&query%5Blandsize%5D%5Bvalue%5D=&query%5Blandareaunit%5D%5Bvalue%5D=&query%5Bsuburbs%5D%5Bvalue%5D%5B%5D=")
    headers = {
        'accept': '*/*',
    ...
    count = 1
    db = 'AllPropertyPeople'
    collection = 'AllPropertyPeople_Rent'
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'All Property People'
            ...
            # sold_price = response.css('.listing-info-price ::text').get('').strip().replace('$','')
