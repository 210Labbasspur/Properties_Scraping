...
class MurrayKennedy_Sold(scrapy.Spider):
    name = 'MurrayKennedy_Sold'
    prefix = 'https://murraykennedyrealestate.com.au'
    url = "https://murraykennedyrealestate.com.au/listings?saleOrRental=Sale&sortby=saleDate-desc&status=sold"
    headers = {
