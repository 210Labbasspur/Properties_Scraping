...
class PPD_Sale(scrapy.Spider):
    name = 'PPD_Sale'
    prefix = 'https://www.ppdre.com.au'
    url = ("https://www.ppdre.com.au/wp-admin/admin-ajax.php?id=properties_search&post_id=8&slug=for-sale&canonical_url=https%3A%2F%2Fwww.ppdre.com.au%2Fproperties%2Ffor-sale%2F&posts_per_page=80&"
           "page={}"
           "&offset=0&post_type=properties&repeater=default&seo_start_page=1&preloaded=false&preloaded_amount=0&taxonomy=listing-type:listing-status&taxonomy_terms=sale:current&taxonomy_operator=IN:IN&order=DESC&orderby=modified&custom_args=kw:;suburbs:;streets:;features-bedrooms:;features-bathrooms:;features-carports:;price:;rent:;layout:;&action=alm_get_posts&query_type=standard")
    headers = {
