...
class Mountview_Rent(scrapy.Spider):
    name = 'Mountview_Rent'
    prefix = 'https://www.mountviewre.com.au'
    url = "https://www.mountviewre.com.au/renting/properties-for-lease/"
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        # 'cookie': 'AMP_MKTG_16a5c84b5b=JTdCJTdE; _ga=GA1.1.1124629272.1714475116; _ga_0TZ64KD7EC=GS1.1.1714513978.2.0.1714513978.0.0.0; AMP_16a5c84b5b=JTdCJTIyZGV2aWNlSWQlMjIlM0ElMjJlYTg4ZTczNC0zZmEyLTQ4MzAtOTE1ZC1jNTJhYTA3ZDlmODElMjIlMkMlMjJzZXNzaW9uSWQlMjIlM0ExNzE0NTEzOTg1NjQ2JTJDJTIyb3B0T3V0JTIyJTNBZmFsc2UlMkMlMjJsYXN0RXZlbnRUaW1lJTIyJTNBMTcxNDUxMzk4NTY5NCU3RA==; arp_scroll_position=3400',
        'priority': 'u=0, i',
        # 'referer': 'https://www.mountviewre.com.au/selling/recent-sales/',
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'MountView Real Estate'
