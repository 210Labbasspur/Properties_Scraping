...
class HockingStuart_Sold(scrapy.Spider):
    name = 'HockingStuart_Sold'
    prefix = 'https://hockingstuart.com.au'
    url = "https://hockingstuart.com.au/listings?propertyType=residential&sort=newold&searchStatus=sold&state=all"
    headers = {
