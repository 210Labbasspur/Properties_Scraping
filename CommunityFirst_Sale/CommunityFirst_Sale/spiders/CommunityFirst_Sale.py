...
class CommunityFirst_Sale(scrapy.Spider):
    name = "CommunityFirst_Sale"

    url = "https://communityfirstrealestate.com.au/buy/"
    ...
    count = 1
    db = 'CommunityFirst'
    collection = 'CommunityFirst_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(CommunityFirst_Sale, self).__init__(*args, **kwargs)
        self.links = []
