...
class BandC_Sale(scrapy.Spider):
    name = 'BandC_Sale'
    prefix = 'https://bollerco.com.au'
    url = ("https://bollerco.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bpost_type%5D%5Btype%5D=equal&query%5Bcount%5D%5Bvalue%5D=20&query%5Bcount%5D%5Btype%5D=equal&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Borderby%5D%5Btype%5D=equal&query%5Bmeta_key%5D%5Bvalue%5D=saleDate&query%5Bmeta_key%5D%5Btype%5D=equal&query%5Bsold%5D%5Bvalue%5D=0&query%5Bsold%5D%5Btype%5D=equal&query%5BsaleOrRental%5D%5Bvalue%5D=Sale&query%5BsaleOrRental%5D%5Btype%5D=equal&query%5Bdoing_wp_cron%5D%5Bvalue%5D=1712806970.8493421077728271484375&query%5Bdoing_wp_cron%5D%5Btype%5D=equal&"
           "query%5Bpaged%5D%5Bvalue%5D={}&query%5Bpaged%5D%5Btype%5D=equal&query%5Bextended%5D%5Bvalue%5D=1&query%5Bminprice%5D%5Bvalue%5D=&query%5Bmaxprice%5D%5Bvalue%5D=&query%5Bminbeds%5D%5Bvalue%5D=&query%5Bmaxbeds%5D%5Bvalue%5D=&query%5Bminbaths%5D%5Bvalue%5D=&query%5Bmaxbaths%5D%5Bvalue%5D=&query%5Bcars%5D%5Bvalue%5D=&query%5Btype%5D%5Bvalue%5D=&query%5Bsubcategory%5D%5Bvalue%5D=&query%5BexternalID%5D%5Bvalue%5D=&query%5Bminbuildarea%5D%5Bvalue%5D=&query%5Bmaxbuildarea%5D%5Bvalue%5D=&query%5Bbuildareaunit%5D%5Bvalue%5D=&query%5Bminlandarea%5D%5Bvalue%5D=&query%5Bmaxlandarea%5D%5Bvalue%5D=&query%5Blandareaunit%5D%5Bvalue%5D=&query%5Border%5D%5Bvalue%5D=&query%5Bsearch%5D%5Bvalue%5D=&query%5Bsuburbs%5D%5Bvalue%5D%5B%5D=&query%5Bsuburbs%5D%5Bvalue%5D%5B%5D=&query%5Bfeatures%5D%5Bvalue%5D%5B%5D=&query%5Bfeatures%5D%5Bvalue%5D%5B%5D=")

    headers = {
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'content-length': '0',
        # 'cookie': '_gid=GA1.3.973012614.1714475188; __eventn_id=ja5257dow8; _gcl_au=1.1.406913851.1714475188; _gat=1; _ga_67P859NBLX=GS1.3.1714510194.2.0.1714510194.60.0.0; _ga=GA1.1.1558144665.1714475188; _ga_LJ3QB6FX5S=GS1.1.1714510194.2.1.1714510198.0.0.0',
        'origin': 'https://bollerco.com.au',
        'priority': 'u=1, i',
        # 'referer': 'https://bollerco.com.au/listings/?post_type=listings&count=20&orderby=meta_value&meta_key=saleDate&sold=1&saleOrRental=Sale&doing_wp_cron=1712806970.8493421077728271484375&paged=1',
    ...
    def parse(self, response):
        ...
        for property in data['data']['listings']:
            ...
            mini_data['prop_type'] = property.get('type')
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Boller & Company Stock and Station Real Estate Agents'
            ...
            # item['Field9'] = response.css('.listing-info-price ::text').get('').strip().replace('$','')
            ...
            if response.css(".single-listing-agents .property-agent-details-wrapper .agent-mb"):
                ...
                if agent1:
                    ...
                    agent1_phone = agent1.xpath(".//*[contains(@data-phonelabel,'agent_mobile')]/a[1]/text()").get('').strip().replace('tel:','')
                    item['Field20'] = agent1_phone.strip()
                    agent1_mobile = agent1.xpath(".//*[contains(@data-phonelabel,'phone')]/a[1]/text()").get('').strip().replace('tel:','')
                ...
                if len(response.css(".single-listing-agents .property-agent-details-wrapper .agent-mb").getall()) > 1:
                    ...
                    if agent2:
                        ...
                        agent2_phone = agent2.xpath(".//*[contains(@data-phonelabel,'agent_mobile')]/a[1]/text()").get('').strip().replace('tel:', '')
                        item['Field26'] = agent2_phone.strip()
                        agent2_mobile = agent2.xpath(".//*[contains(@data-phonelabel,'phone')]/a[1]/text()").get('').strip().replace('tel:', '')
                ...
                if len(response.css(".single-listing-agents .property-agent-details-wrapper .agent-mb").getall()) == 3:
                    ...
                    if agent3:
                        ...
                        agent3_phone = agent3.xpath(".//*[contains(@data-phonelabel,'agent_mobile')]/a[1]/text()").get('').strip().replace('tel:', '')
                        item['Field31'] = agent3_phone.strip()
                        agent3_mobile = agent3.xpath(".//*[contains(@data-phonelabel,'phone')]/a[1]/text()").get('').strip().replace('tel:', '')
            ...
            item['Field35'] = mini_data['prop_type']
