...
class LaurenceMorgan_Rent(scrapy.Spider):
    name = "LaurenceMorgan_Rent"
    ...
    data = {
            ...
            'slf_sort': 'new-old',
            'slf_paged': '1',
            'slf_property_status': 'current',
            'slf_loadmore': 'false',
        }
    count = 1
    db = 'LaurenceMorgan'
    collection = 'LaurenceMorgan_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(LaurenceMorgan_Rent, self).__init__(*args, **kwargs)
        self.links = []
