...
class ShawnKym_Sale(scrapy.Spider):
    name = "ShawnKym_Sale"
    url = 'https://www.shawnandkymrealestate.com.au/wp-admin/admin-ajax.php'
    prefix = "https://www.shawnandkymrealestate.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(ShawnKym_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(3252)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Shawn and Kym Real Estate'
