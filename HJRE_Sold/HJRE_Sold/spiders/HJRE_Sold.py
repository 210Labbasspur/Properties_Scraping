...
class HJRE_Sold(scrapy.Spider):
    name = "HJRE_Sold"
    url = "https://hjre.com.au/listings/?saleOrRental=sale&status=sold&sortby=saleDate-desc"
    prefix = "https://hjre.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(HJRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def start_requests(self):
        ...
        yield scrapy.Request('https://hjre.com.au/listings/?saleOrRental=sale&status=sold&sortby=saleDate-desc&page=27',
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://hjre.com.au{each_url}'
        ...
        for property_url in all_links:
            property_url = f'https://hjre.com.au{property_url}'
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2092)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Havig & Jackson Real Estate'
            ...
            input_string = response.xpath("//*[contains(text(),'thumbLocation')]/text()").get('').strip()
            full_image_urls = re.findall(r'"full":"(.*?)"', input_string)
            prop_images = ["https:" + url.replace('\\', '') for url in full_image_urls]
            images = []
