...
class StantonTaylor_Sold(scrapy.Spider):
    name = 'StantonTaylor_Sold'
    prefix = 'https://www.stantonandtaylor.com.au'
    url = "https://www.stantonandtaylor.com.au/data/results/?listing_sale_method=Sale&listing_status=sold&status=sold&pg={}"
    headers = {
        'accept': '*/*',
