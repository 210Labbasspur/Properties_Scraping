...
class SweetRealty_Rent(scrapy.Spider):
    name = "SweetRealty_Rent"

    url = "http://www.sweetrealty.com.au/for-rent"
    ...
    count = 1
    db = 'SweetRealty'
    collection = 'SweetRealty_Rent'
    bucket_prefix = f'SR_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(SweetRealty_Rent, self).__init__(*args, **kwargs)
        self.links = []
