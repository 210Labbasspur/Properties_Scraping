...
class SPGR_Sale(scrapy.Spider):
    name = "SPGR_Sale"
    url = 'https://www.spgr.com.au/wp-admin/admin-ajax.php'
    prefix = "https://www.spgr.com.au"
    headers = {
    ...
    'atts[property_type_list]': 'House,Apartment',
    'atts[page_list]': 'Off The Plan::https://www.spgr.com.au/buy/project-for-sale/,Land::https://www.spgr.com.au/buy/?property_type=Land,Commercial::https://www.spgr.com.au/buy/commercial-for-sale/',
    ...
    def __init__(self, *args, **kwargs):
        super(SPGR_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            ...
            item['Field9'] = response.css('.status-price ::text').get('').strip().replace('$','').replace(',','').replace(' ','')
