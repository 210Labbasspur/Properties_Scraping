...
class BellaCP_Rent(scrapy.Spider):
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Bella Coastal Property'
