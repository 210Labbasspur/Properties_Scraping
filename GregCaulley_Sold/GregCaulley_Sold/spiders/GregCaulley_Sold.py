...
class GregCaulley_Sold(scrapy.Spider):
    name = "GregCaulley_Sold"

    url = "https://gregcaulleyrealty.com.au/sold"
    ...
    def __init__(self, *args, **kwargs):
        super(GregCaulley_Sold, self).__init__(*args, **kwargs)
        self.links = []
