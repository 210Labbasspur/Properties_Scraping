...
class WattR_Sale(scrapy.Spider):
    name = "WattR_Sale"

    url = "https://www.wattrealty.com.au/property/?buyrent=Sale&include-suburbs=1"
    ...
    def __init__(self, *args, **kwargs):
        super(WattR_Sale, self).__init__(*args, **kwargs)
        self.links = []
