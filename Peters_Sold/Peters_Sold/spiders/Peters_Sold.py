...
class Peters_Sold(scrapy.Spider):
    name = 'Peters_Sold'
    prefix = 'https://www.petersrealestate.com.au'
    url = 'https://www.petersrealestate.com.au/wp-admin/admin-ajax.php'
    headers = {
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
        # 'cookie': '_ga=GA1.1.1825895937.1713706659; arp_scroll_position=1943; _ga_1E2PX7HPGT=GS1.1.1713951755.3.0.1713951995.0.0.0',
        'origin': 'https://www.petersrealestate.com.au',
        'priority': 'u=1, i',
        # 'referer': 'https://www.petersrealestate.com.au/sell/recently-sold/',
    ...
    data = {
        ...
        'atts[row_col_class]': 'row row-cols-xl-3 row-cols-lg-2 row-cols-1',        'atts[per_page]': '18',
        'atts[sur_suburbs]': '0',        'atts[center_latlng]': '',        'atts[sur_suburbs_radius]': '10',
        'atts[max_page]': 'false',        'atts[map_zoom]': '11',        'atts[map]': 'map_canvas',        'atts[map_load_all_marker]': '0',
        'atts[map_callback]': 'ap_realty.searchResultsMapCallback',        'atts[map_attribute_cluster]': '0',
        'atts[map_is_visible]': '0',        'atts[property_type_column]': '1,2,3',
        ...
        'atts[map_attribute_loadCallback]': 'ap_realty.searchResultsMapCallback',        'atts[sort]': 'latest_updated',
        'per_page': '18',        'load_more': 'true',        'selector': '#ap-listing-search-results',
        'selectorMap': '#map_canvas',        'sort': 'latest_updated',        'action': 'property_search_results',
        'current_page': '',
    }
    count = 1
    db = 'Peters'
    collection = 'Peters_Sold'
    ...
    def parse(self, response):
        ...
        for property in data['data']['props']:
            ...
            mini_data['car'] = int(property.get('garage')) + int(property.get('carport'))
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Peters Real Estate'
            ...
            Agent_Imagess = response.xpath("//*[contains(@class,'embed-responsive embed-responsive-16by9')]/picture/source/img/@src").getall()
            new_img_urls = []
            ...
            if response.css(".listing-agent"):
                ...
                agent1_name = agent1.css('.agent-name .mb-0 ::text').get('').strip()
                if agent1:
                ...
                if len(response.css(".listing-agent").getall()) > 1:
                    ...
                    agent2_name = agent2.css('.agent-name .mb-0 ::text').get('').strip()
                    if agent2:
