...
class MotionProperty_Rent(scrapy.Spider):
    name = "MotionProperty_Rent"

    url = "https://motionproperty.com.au/rental/?_status=current"
    ...
    count = 1
    db = 'MotionProperty'
    collection = 'MotionProperty_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(MotionProperty_Rent, self).__init__(*args, **kwargs)
        self.links = []
