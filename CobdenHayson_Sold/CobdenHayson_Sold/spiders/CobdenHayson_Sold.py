...
class CobdenHayson_Sold(scrapy.Spider):
    name = "CobdenHayson_Sold"

    url = "https://www.ch.com.au/sold/?ltype=&list=latest_sold&keywords=&price_min=&price_max=&bedrooms=&bathrooms=&carspaces=&email_address=&type="
    ...
    def __init__(self, *args, **kwargs):
        super(CobdenHayson_Sold, self).__init__(*args, **kwargs)
        self.links = []
