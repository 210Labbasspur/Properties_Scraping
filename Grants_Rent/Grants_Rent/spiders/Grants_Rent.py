...
class Grants_Rent(scrapy.Spider):
    name = "Grants_Rent"

    url = "https://www.grantsea.com.au/?action=epl_search&post_type=rental&property_status=current"
    ...
    def __init__(self, *args, **kwargs):
        super(Grants_Rent, self).__init__(*args, **kwargs)
        self.links = []
