...
class HJRE_Rent(scrapy.Spider):
    name = "HJRE_Rent"
    url = "https://hjre.com.au/listings?saleOrRental=Rental&status=available_under_contract&sortby=dateListed-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(HJRE_Rent, self).__init__(*args, **kwargs)
        self.links = []
