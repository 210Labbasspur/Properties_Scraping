...
class PocketListings_Sold(scrapy.Spider):
    name = "PocketListings_Sold"

    url = "https://pocketlistings.com.au/recent-sales/"
    ...
    count = 1
    db = 'PocketListings'
    collection = 'PocketListings_Sold'
    bucket_prefix = f'PL_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(PocketListings_Sold, self).__init__(*args, **kwargs)
        self.links = []
