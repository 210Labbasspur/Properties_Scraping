...
class PropertyforYou_Sold(scrapy.Spider):
    name = "PropertyforYou_Sold"

    url = "https://property4you.com.au/listings/?saleOrRental=Sale&rental_period=week&status=sold&viewType=gallery&page=1"
    ...
    count = 1
    db = 'PropertyforYou'
    collection = 'PropertyforYou_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(PropertyforYou_Sold, self).__init__(*args, **kwargs)
        self.links = []
