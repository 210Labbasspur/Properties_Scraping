...
class Coastal_Sold(scrapy.Spider):
    name = "Coastal_Sold"
    url = 'https://www.coastal.com.au/wp-json/api/listings/all?priceRange=&landArea=&floorArea=&limit=12&type=property&status=sold&address=&paged={}&bed=&bath=&car=&sort='
    ...
    def __init__(self, *args, **kwargs):
        super(Coastal_Sold, self).__init__(*args, **kwargs)
        self.links = []
