...
class Position_Sale(scrapy.Spider):
    name = "Position_Sale"

    url = "https://www.positionproperty.com.au/buying/property-search"
    ...
    def __init__(self, *args, **kwargs):
        super(Position_Sale, self).__init__(*args, **kwargs)
        self.links = []
