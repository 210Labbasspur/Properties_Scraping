...
class ThePropertyShop_Sale(scrapy.Spider):
    name = 'ThePropertyShop_Sale'
    prefix = 'https://www.thepropertyshop.com.au'
    url = "https://www.thepropertyshop.com.au/buying/residential-property/"
    headers = {
    ...
    count = 1
    db = 'ThePropertyShop'
    collection = 'ThePropertyShop_Sale'
