...
class RandW_Sold(scrapy.Spider):
    name = 'RandW_Sold'
    prefix = 'https://www.randw.com.au'
    url = 'https://www.randw.com.au/property-sold.html'
    headers = {
        'accept': '*/*',
    ...
    data = {
        ...
        '28[offset]': '0',
        '28[perpage]': '6',
        'MinDate': '1651494700',        'IsOffmarket': '-1',
        'SalesStageID[0]': 'EXCHANGED_REPORTED',        'SalesStageID[1]': 'COMPLETED',
        'require': '0',        'fgpid': '28',        'ajax': '1',
    }

    count = 1
    db = 'RandW'
    collection = 'RandW_Sold'
    bucket_prefix = f'D_{collection}'

    def start_requests(self):
        property_no = 0
        payload = deepcopy(self.data)
        payload['28[offset]'] = str(property_no)
