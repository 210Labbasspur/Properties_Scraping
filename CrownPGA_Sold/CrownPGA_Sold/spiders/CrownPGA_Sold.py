...
class CrownPGA_Sold(scrapy.Spider):
    name = "CrownPGA_Sold"

    url = "https://home.crownpga.com.au/selling/recent-sales"
    ...
    def __init__(self, *args, **kwargs):
        super(CrownPGA_Sold, self).__init__(*args, **kwargs)
        self.links = []
