...
class GregCaulley_Sale(scrapy.Spider):
    name = "GregCaulley_Sale"

    url = "https://gregcaulleyrealty.com.au/buy"
    ...
    def __init__(self, *args, **kwargs):
        super(GregCaulley_Sale, self).__init__(*args, **kwargs)
        self.links = []
