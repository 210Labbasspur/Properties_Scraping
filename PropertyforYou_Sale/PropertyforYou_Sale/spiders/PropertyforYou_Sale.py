...
class PropertyforYou_Sale(scrapy.Spider):
    name = "PropertyforYou_Sale"

    url = "https://property4you.com.au/listings/?saleOrRental=Sale&order=dateListed-desc"
    ...
    count = 1
    db = 'PropertyforYou'
    collection = 'PropertyforYou_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(PropertyforYou_Sale, self).__init__(*args, **kwargs)
        self.links = []
