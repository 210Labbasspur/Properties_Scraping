...
class Barnett_Sale(scrapy.Spider):
    name = "Barnett_Sale"

    url = "https://barnettproperty.com.au/search/?show_in_sale=true&sold=0"
    ...
    count = 1
    db = 'Barnett'
    collection = 'Barnett_Sale'
    bucket_prefix = f'WEA_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(Barnett_Sale, self).__init__(*args, **kwargs)
        self.links = []
