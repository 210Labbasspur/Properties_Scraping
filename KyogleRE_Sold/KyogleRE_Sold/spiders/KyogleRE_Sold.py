...
class KyogleRE_Sold(scrapy.Spider):
    name = 'KyogleRE_Sold'
    prefix = 'https://www.kyoglerealestate.com'
    url = "https://www.kyoglerealestate.com/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold"
    headers = {
        'accept': '*/*',
