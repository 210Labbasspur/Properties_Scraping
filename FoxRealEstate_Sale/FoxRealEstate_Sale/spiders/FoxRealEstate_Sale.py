...
class FoxRealEstate_Sale(scrapy.Spider):
    name = "FoxRealEstate_Sale"
    ...
    def __init__(self, *args, **kwargs):
        super(FoxRealEstate_Sale, self).__init__(*args, **kwargs)
        self.links = []
