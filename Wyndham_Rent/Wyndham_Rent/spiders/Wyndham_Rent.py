...
class Wyndham_Rent(scrapy.Spider):
    name = "Wyndham_Rent"

    url = "https://wyndhamre.com.au/search/?show_in_rental=true&sold=0"
    ...
    def __init__(self, *args, **kwargs):
        super(Wyndham_Rent, self).__init__(*args, **kwargs)
        self.links = []
