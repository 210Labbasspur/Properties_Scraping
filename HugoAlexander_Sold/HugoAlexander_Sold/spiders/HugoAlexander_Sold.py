...
class HugoAlexander_Sold(scrapy.Spider):
    name = "HugoAlexander_Sold"

    url = "https://hugoalexander.com.au/sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(HugoAlexander_Sold, self).__init__(*args, **kwargs)
        self.links = []
