...
class Leader_Rent(scrapy.Spider):
    name = 'Leader_Rent'
    prefix = 'https://www.leaderproperties.com.au'
    url = "https://www.leaderproperties.com.au/renting/properties-for-lease/"
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'cache-control': 'max-age=0',
        # 'cookie': '_ga=GA1.1.394622703.1713700491; arp_scroll_position=400; _ga_VTTFGZ5K6G=GS1.1.1713711260.3.0.1713711260.0.0.0',
        'priority': 'u=0, i',
    ...
    count = 1
    db = 'Leader_Properties'
    collection = 'Leader_Rent'
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Leader Properties Real Estate'
            ...
            if len(response.css(".mb-20").getall()) > 1:
                ...
                if agent2:
                    ...
                    agent2_phone = agent2.css(".mobile a ::text").get('').strip()
                    item['Field26'] = agent2_phone.strip()
                    agent2_mobile = agent2.css(".phone a ::text").get('').strip()
            ...
            if len(response.css(".mb-20").getall()) == 3:
                ...
                if agent3:
                    ...
                    agent3_phone = agent3.css(".mobile a ::text").get('').strip()
