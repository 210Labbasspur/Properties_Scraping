...
class Salt_Sale(scrapy.Spider):
    name = 'Salt_Sale'
    prefix = 'https://saltpropertynewcastle.com.au'
    url = "https://saltpropertynewcastle.com.au/for-sale/"
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'cache-control': 'max-age=0',
        # 'cookie': '_gcl_au=1.1.1521717054.1713706576; _gid=GA1.3.237850821.1713876914; _ga_5H0N258LQK=GS1.1.1713876913.2.1.1713876987.60.0.0; _ga=GA1.3.541169582.1713706576; arp_scroll_position=400',
        'priority': 'u=0, i',
