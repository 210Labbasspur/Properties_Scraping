...
class ThePropertyCo_Rent(scrapy.Spider):
    name = 'ThePropertyCo_Rent'
    prefix = 'https://www.thepropertyco.com.au'
    url = 'https://www.thepropertyco.com.au/wp-admin/admin-ajax.php'
    headers = {
        'accept': '*/*',
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'The Property Co Group'
