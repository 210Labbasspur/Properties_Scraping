...
class Ballarat_Rent(scrapy.Spider):
    name = "Ballarat_Rent"

    url = "https://www.ballaratrealestate.com.au/rent/for-lease/"
    ...
    def __init__(self, *args, **kwargs):
        super(Ballarat_Rent, self).__init__(*args, **kwargs)
        self.links = []
