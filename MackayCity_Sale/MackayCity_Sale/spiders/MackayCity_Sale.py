...
class MackayCity_Sale(scrapy.Spider):
    name = "MackayCity_Sale"

    url = "https://mackaycityproperty.com.au/residential-property-listings-mackay/"
    ...
    def __init__(self, *args, **kwargs):
        super(MackayCity_Sale, self).__init__(*args, **kwargs)
        self.links = []
