...
class LaurenceMorgan_Sale(scrapy.Spider):
    name = "LaurenceMorgan_Sale"
    ...
    count = 1
    db = 'LaurenceMorgan'
    collection = 'LaurenceMorgan_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(LaurenceMorgan_Sale, self).__init__(*args, **kwargs)
        self.links = []
