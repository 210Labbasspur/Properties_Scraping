...
class OlsenRomano_Sale(scrapy.Spider):
    name = 'OlsenRomano_Sale'
    ...
    url = ("https://www.olsenromano.com.au/wp-content/themes/ap-olsen/zoorealty/display/elements/load_listings.php?post_id=&status"
           "=1&list=sale&order=&order_direction=&property_type=&keywords=&price_min=&price_max=&bedrooms=&page={}")
    headers = {
