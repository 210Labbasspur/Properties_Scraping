...
class NoakesNickolas_Rent(scrapy.Spider):
    name = "NoakesNickolas_Rent"

    url = "https://noakesnickolas.com.au/listings/?status=For+Lease&property-type=All&price=&order=NEWEST+TO+OLDEST&price-range-select-min=0&price-range-select=10000000"
    ...
    count = 1
    db = 'NoakesNickolas'
    collection = 'NoakesNickolas_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(NoakesNickolas_Rent, self).__init__(*args, **kwargs)
        self.links = []
