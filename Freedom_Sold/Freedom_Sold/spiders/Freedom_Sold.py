...
class Freedom_Sold(scrapy.Spider):
    name = "Freedom_Sold"

    url = "https://www.freedomproperty.com.au/Sold?includeSurrounds=true&excludeContracts=false&p={}&s="
    ...
    def __init__(self, *args, **kwargs):
        super(Freedom_Sold, self).__init__(*args, **kwargs)
        self.links = []
