...
class NashVille_Sold(scrapy.Spider):
    name = "NashVille_Sold"

    url = "https://www.nashvilleproperty.com.au/ajax/residential-proprties.php?data%5Bpage%5D={}&data%5Bstatus%5D=sold&data%5BsaleOrLease%5D="
    ...
    def __init__(self, *args, **kwargs):
        super(NashVille_Sold, self).__init__(*args, **kwargs)
        self.links = []
