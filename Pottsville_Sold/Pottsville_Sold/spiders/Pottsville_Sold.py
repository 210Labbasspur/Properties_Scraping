...
class Pottsville_Sold(scrapy.Spider):
    name = 'Pottsville_Sold'
    prefix = 'https://www.pottsvilleproperties.com'
    url = "https://www.pottsvilleproperties.com/sell/browse-sold-properties/"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Pottsville Properties'
