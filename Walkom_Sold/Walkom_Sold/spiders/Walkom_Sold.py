...
class Walkom_Sold(scrapy.Spider):
    name = 'Walkom_Sold'
    ...
    # data = ('page=1'
    #         '&dlist=sale&dsuburb=&office_id=&keywords=&price_min=&price_max=&bedrooms=&bathrooms=&carspaces=&status=2'
    #         '&order=field(properties.id%2C1902402%2C3658072)+desc%2C+new+desc%2C+properties.created_at&order_direction=desc')
    data = {
        'page': '0',
        'dlist': 'sale',
        'dsuburb': '', 'office_id': '', 'keywords': '', 'price_min': '',
        'price_max': '', 'bedrooms': '', 'bathrooms': '', 'carspaces': '',
        'order': 'created_at', 'order_direction': 'desc', 'status': '2',
    }
    count = 1
    db = 'Walkom'
    collection = 'Walkom_Sold'
