...
class Geelong_Rent(scrapy.Spider):
    name = "Geelong_Rent"

    url = "https://www.geelongrealestate.co/property-category/for-lease/"
    ...
    def __init__(self, *args, **kwargs):
        super(Geelong_Rent, self).__init__(*args, **kwargs)
        self.links = []
