...
class ithink_Sold(scrapy.Spider):
    name = "ithink_Sold"

    url = "https://www.ithinkproperty.com.au/sell/recently-sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(ithink_Sold, self).__init__(*args, **kwargs)
        self.links = []
