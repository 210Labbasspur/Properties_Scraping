...
class PlumProperty_Rent(scrapy.Spider):
    name = "PlumProperty_Rent"
    ...
    def __init__(self, *args, **kwargs):
        super(PlumProperty_Rent, self).__init__(*args, **kwargs)
        self.links = []
