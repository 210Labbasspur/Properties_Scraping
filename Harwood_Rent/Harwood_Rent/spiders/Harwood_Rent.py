...
class Harwood_Rent(scrapy.Spider):
    name = "Harwood_Rent"

    url = "https://www.harwoodproperty.com.au/properties-for-rent/"
    ...
    def __init__(self, *args, **kwargs):
        super(Harwood_Rent, self).__init__(*args, **kwargs)
        self.links = []
