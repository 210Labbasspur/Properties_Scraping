...
class Parnell_Rent(scrapy.Spider):
    name = 'Parnell_Rent'
    prefix = 'https://www.parnellpartners.com.au'
    url = "https://www.parnellpartners.com.au/leasing/properties-for-lease/"
    headers = {
