...
class BundaBerg_Rent(scrapy.Spider):
    name = 'BundaBerg_Rent'
    url = ('https://www.bundaberg.realway.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bcount%5D%5Bvalue%5D=20&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Bmeta_key%5D%5Bvalue%5D=dateListed&query%5Bsold%5D%5Bvalue%5D=0&query%5BsaleOrRental%5D%5Bvalue%5D=Rental&query%5BsaleOrRental%5D%5Btype%5D=equal&query'
           '%5Bpaged%5D%5Bvalue%5D={}')
    prefix = "https://www.bundaberg.realway.com.au"
    headers = {
    ...
    count = 1
    db = 'BundaBerg'
    collection = 'BundaBerg_Rent'
    bucket_prefix = f'Images6'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(BundaBerg_Rent, self).__init__(*args, **kwargs)
        self.links = []
