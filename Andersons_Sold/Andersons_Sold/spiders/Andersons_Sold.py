...
class Andersons_Sold(scrapy.Spider):
    name = "Andersons_Sold"

    url = "https://www.andersonsrealestate.com.au/properties-for-sale/?status=sold"
    ...
    def __init__(self, *args, **kwargs):
        super(Andersons_Sold, self).__init__(*args, **kwargs)
        self.links = []
