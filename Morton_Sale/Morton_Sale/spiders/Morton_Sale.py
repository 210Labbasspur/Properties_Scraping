...
class Morton_Sale(scrapy.Spider):
    name = 'Morton_Sale'
    prefix = 'https://www.morton.com.au'
    url = "https://www.morton.com.au/wp-admin/admin-ajax.php"
    headers = {
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
        # 'cookie': '_ga=GA1.1.457152253.1713301056; _ga_QBCGTW94DT=GS1.1.1713442544.2.1.1713444307.60.0.0; arp_scroll_position=5789',
        'origin': 'https://www.morton.com.au',
        'priority': 'u=1, i',
        'referer': 'https://www.morton.com.au/sell/recent-sales/',
    ...
    data = {
        ...
        'atts[load_more]': 'true',        'atts[hide_search_form]': '0',
        'atts[row_col_class]': 'row row-cols-xl-3 row-cols-lg-2 row-cols-1',
        'atts[per_page]': '16',        'atts[sur_suburbs]': '0',        'atts[center_latlng]': '',
        'atts[sur_suburbs_radius]': '10',        'atts[max_page]': 'false',
        'atts[map_zoom]': '11',        'atts[map]': 'map_canvas',
        'atts[map_load_all_marker]': '0',        'atts[map_callback]': 'ap_realty.searchResultsMapCallback',
        'atts[map_attribute_cluster]': '0',        'atts[map_is_visible]': '1',
        'atts[property_type_column]': '1,2,3',        'atts[content_first]': '0',      'atts[auth]': '0',
        ...
        'atts[offices][0][id]': '19214',        'atts[offices][0][name]': 'Morton - Crows Nest',
        'atts[offices][1][id]': '19215',        'atts[offices][1][name]': 'Morton - Pyrmont',
        'atts[offices][2][id]': '19216',        'atts[offices][2][name]': 'Morton - Woolloomooloo',
        'atts[offices][3][id]': '19217',        'atts[offices][3][name]': 'Morton - Green Square',
        'atts[offices][4][id]': '19218',        'atts[offices][4][name]': 'Morton - Sydney',
        'atts[offices][5][id]': '19219',        'atts[offices][5][name]': 'Morton - Newington',
        'atts[offices][6][id]': '19220',        'atts[offices][6][name]': 'Morton - Penrith',
        'atts[offices][7][id]': '19221',        'atts[offices][7][name]': 'Morton - Riverwood',
        'atts[load_more_automatic]': 'true',        'atts[sort]': '-sold_at,-id',
        'load_more': 'true',        'selectorMap': '#map_canvas',
        'selector': '#ap-listing-search-results',        'sort': '-sold_at,-id',        'action': 'property_search_results',
        'per_page': '16',
        'current_page': '',
    }
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field12'] = mini_data.get('description')
            ...
            if agent1:
                ...
                agent1_phone = agent1.xpath(".//a[contains(@href,'tel:')]/@href").get('').strip().replace('tel:','')  # description
            ...
            if len(response.css(".listing-agent").getall()) > 1:
                ...
                if agent2:
                    ...
                    agent2_phone = agent2.xpath(".//a[contains(@href,'tel:')]/@href").get('').strip().replace('tel:',                                                                                                              '')  # description
            ...
            if len(response.css(".listing-agent").getall()) == 3:
                ...
                if agent3:
                    ...
                    agent3_phone = agent3.xpath(".//a[contains(@href,'tel:')]/@href").get('').strip().replace('tel:',                                                                                                              '')  # description
