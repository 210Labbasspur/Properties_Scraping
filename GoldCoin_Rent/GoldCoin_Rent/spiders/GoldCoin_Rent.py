...
class GoldCoin_Rent(scrapy.Spider):
    name = "GoldCoin_Rent"
    url = 'https://www.goldcoinrealestate.com.au/pages/real-estate/results?widgetKey=134300&context=listings&returnAs=markup&listing_sale_method=lease&display_sale_method=RENT&pg=1'
    ...
    def __init__(self, *args, **kwargs):
        super(GoldCoin_Rent, self).__init__(*args, **kwargs)
        self.links = []
