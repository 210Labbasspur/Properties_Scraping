...
class ExclusiveRE_Rent(scrapy.Spider):
    name = 'ExclusiveRE_Rent'
    prefix = 'https://www.exclusivere.com.au'
    url = "https://www.exclusivere.com.au/rent"
    headers = {
    ...
    def parse(self, response):
        for property in response.css("h4 a"):
