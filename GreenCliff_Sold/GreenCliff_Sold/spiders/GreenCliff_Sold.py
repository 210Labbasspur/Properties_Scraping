...
class GreenCliff_Sold(scrapy.Spider):
    name = 'GreenCliff_Sold'
    prefix = 'https://www.greencliff.com.au'
    url = "https://www.greencliff.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold"
    headers = {
        'accept': '*/*',
