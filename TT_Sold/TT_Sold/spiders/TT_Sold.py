...
class TT_Sold(scrapy.Spider):
    name = 'TT_Sold'
    prefix = 'https://www.tahliathomasrealestate.com.au'
    url = "https://www.tahliathomasrealestate.com.au/sell/"
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'cache-control': 'max-age=0',
        # 'cookie': '_ga=GA1.1.517283000.1713706704; _ga_TYD86EYSCS=GS1.1.1713870525.2.0.1713870525.0.0.0',
        'priority': 'u=0, i',
    ...
    def parse(self, response):
        for property in response.css(".bg-black-5 a"):
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Tahlia Thomas Real Estate'
            ...
            item['Field6'] = ''.join(element.strip() for element in response.css(".bed ::text").getall())
            item['Field7'] = ''.join(element.strip() for element in response.css(".bath ::text").getall())
            item['Field8'] = ''.join(element.strip() for element in response.css(".car ::text").getall())
