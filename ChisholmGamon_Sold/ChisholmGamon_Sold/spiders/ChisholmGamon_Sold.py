...
class ChisholmGamon_Sold(scrapy.Spider):
    name = "ChisholmGamon_Sold"

    url = "https://chisholmgamon.com.au/sell/sold-properties?page={}"
    ...
    def __init__(self, *args, **kwargs):
        super(ChisholmGamon_Sold, self).__init__(*args, **kwargs)
        self.links = []
