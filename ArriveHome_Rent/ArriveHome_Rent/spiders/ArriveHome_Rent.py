...
class ArriveHome_Rent(scrapy.Spider):
    name = "ArriveHome_Rent"
    url = 'https://arrivehome.com.au/wp-json/api/listings/all?priceRange=&type=rental&status=current&paged={}&limit=16&address=&bed=&bath=&car=&sort='
    ...
    def __init__(self, *args, **kwargs):
        super(ArriveHome_Rent, self).__init__(*args, **kwargs)
        self.links = []
