...
class SweetRealty_Sale(scrapy.Spider):
    name = "SweetRealty_Sale"

    url = "http://www.sweetrealty.com.au/for-sale"
    ...
    count = 1
    db = 'SweetRealty'
    collection = 'SweetRealty_Sale'
    bucket_prefix = f'SR_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(SweetRealty_Sale, self).__init__(*args, **kwargs)
        self.links = []
