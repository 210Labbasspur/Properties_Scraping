...
class PaynePacific_Sold(scrapy.Spider):
    name = 'PaynePacific_Sold'
    prefix = 'https://www.paynepacific.com.au'
    url = "https://www.paynepacific.com.au/buy/recently-sold/"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Payne Pacific Real Estate'
            ...
            elif response.xpath("//*[contains(text(),'Car Spaces')]/following-sibling::div[1]/text()").get('').strip():
