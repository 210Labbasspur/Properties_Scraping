...
class Sutton_Rent(scrapy.Spider):
    name = "Sutton_Rent"

    url = "https://www.suttonnationwiderealty.com.au/rent/homes-for-rent/page/{}/"
    ...
    def __init__(self, *args, **kwargs):
        super(Sutton_Rent, self).__init__(*args, **kwargs)
        self.links = []
