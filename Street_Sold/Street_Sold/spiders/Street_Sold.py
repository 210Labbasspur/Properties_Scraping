...
class Street_Sold(scrapy.Spider):
    name = 'Street_Sold'
    prefix = 'https://www.street.net.au'
    url = 'https://www.street.net.au/wp-admin/admin-ajax.php'
    headers = {
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
        # 'cookie': '_ga=GA1.1.1138623997.1714476000; _ga_PVNT8MK4BN=GS1.1.1714689581.3.0.1714689581.0.0.0; arp_scroll_position=2714',
        'origin': 'https://www.street.net.au',
        'priority': 'u=1, i',
        # 'referer': 'https://www.street.net.au/sell/sold/',
