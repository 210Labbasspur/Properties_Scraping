...
class HJRE_Sale(scrapy.Spider):
    name = "HJRE_Sale"
    url = "https://hjre.com.au/listings?saleOrRental=Sale&status=available_under_contract&sortby=dateListed-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(HJRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
