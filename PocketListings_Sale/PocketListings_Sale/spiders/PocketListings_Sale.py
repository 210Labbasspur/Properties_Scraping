...
class PocketListings_Sale(scrapy.Spider):
    name = "PocketListings_Sale"

    url = "https://pocketlistings.com.au/properties-for-sale/"
    ...
    count = 1
    db = 'PocketListings'
    collection = 'PocketListings_Sale'
    bucket_prefix = f'PL_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(PocketListings_Sale, self).__init__(*args, **kwargs)
        self.links = []
