...
class ReMaxPS_Sale(scrapy.Spider):
    name = "ReMaxPS_Sale"

    url = "https://www.remaxpropertysales.com.au/buying/residential-homes"
    ...
    def __init__(self, *args, **kwargs):
        super(ReMaxPS_Sale, self).__init__(*args, **kwargs)
        self.links = []
