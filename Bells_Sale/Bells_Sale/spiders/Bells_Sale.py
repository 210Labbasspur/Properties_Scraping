...
class Bells_Sale(scrapy.Spider):
    name = "Bells_Sale"
    url = 'https://www.bellsrealestate.com.au/data/results/?listing_sale_method=Sale&gallery=1&pg={}'
    ...
    def __init__(self, *args, **kwargs):
        super(Bells_Sale, self).__init__(*args, **kwargs)
        self.links = []
