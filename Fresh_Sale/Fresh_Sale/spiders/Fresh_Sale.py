...
class Fresh_Sale(scrapy.Spider):
    name = 'Fresh_Sale'
    prefix = 'https://listing.freshpropertyagents.com.au'
    url = "https://listing.freshpropertyagents.com.au/?action=epl_search&post_type=property&property_status=current"
    headers = {
