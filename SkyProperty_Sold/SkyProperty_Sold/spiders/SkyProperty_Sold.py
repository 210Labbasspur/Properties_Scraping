...
class SkyProperty_Sold(scrapy.Spider):
    name = "SkyProperty_Sold"

    url = "https://www.skyproperty.com.au/selling/recent-sales/"
    ...
    count = 1
    db = 'SkyProperty'
    collection = 'SkyProperty_Sold'
    bucket_prefix = f'SkyProperty_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(SkyProperty_Sold, self).__init__(*args, **kwargs)
        self.links = []
