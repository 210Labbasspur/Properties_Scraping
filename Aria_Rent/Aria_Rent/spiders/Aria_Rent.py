...
class Aria_Rent(scrapy.Spider):
    name = 'Aria_Rent'
    prefix = 'https://www.ariarealtyco.com.au'
    url = 'https://www.ariarealtyco.com.au/wp-admin/admin-ajax.php'
    headers = {
        'accept': '*/*',
