...
class Impact_Rent(scrapy.Spider):
    name = "Impact_Rent"

    url = "https://www.impactrealtygroup.com.au/properties-for-lease/"
    ...
    def __init__(self, *args, **kwargs):
        super(Impact_Rent, self).__init__(*args, **kwargs)
        self.links = []
