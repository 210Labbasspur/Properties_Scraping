...
class BradyResidential_Sale(scrapy.Spider):
    name = "BradyResidential_Sale"

    url = "https://www.bradyresidential.com.au/buy/search-properties/"
    ...
    count = 1
    db = 'BradyResidential'
    collection = 'BradyResidential_Sale'
    bucket_prefix = f'BR_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(BradyResidential_Sale, self).__init__(*args, **kwargs)
        self.links = []
