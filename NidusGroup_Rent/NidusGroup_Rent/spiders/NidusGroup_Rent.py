...
class NidusGroup_Rent(scrapy.Spider):
    name = 'NidusGroup_Rent'
    prefix = 'https://nidusgroupre.com.au'
    url = "https://nidusgroupre.com.au/properties-for-rent/"
    headers = {
    ...
    def parse(self, response):
        for property in response.css(".find-property__prop-link"):
