...
class Barnett_Sold(scrapy.Spider):
    name = "Barnett_Sold"

    url = "https://barnettproperty.com.au/search/?show_in_sale=true&sold=1"
    ...
    count = 1
    db = 'Barnett'
    collection = 'Barnett_Sold'
    bucket_prefix = f'WEA_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(Barnett_Sold, self).__init__(*args, **kwargs)
        self.links = []
