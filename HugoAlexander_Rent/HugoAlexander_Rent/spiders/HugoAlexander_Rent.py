...
class HugoAlexander_Rent(scrapy.Spider):
    name = "HugoAlexander_Rent"

    url = "https://hugoalexander.com.au/for-rent/"
    ...
    def __init__(self, *args, **kwargs):
        super(HugoAlexander_Rent, self).__init__(*args, **kwargs)
        self.links = []
