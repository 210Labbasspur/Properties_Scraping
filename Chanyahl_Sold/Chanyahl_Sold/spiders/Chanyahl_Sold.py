...
class Chanyahl_Sold(scrapy.Spider):
    name = 'Chanyahl_Sold'
    prefix = 'https://chanyahl.com.au'
    url = "https://chanyahl.com.au/wp-json/api/listings/all?priceRange=&limit=12&type=property&status=sold&address=&paged={}&bed=&bath=&car=&sort=&homeLand=&landProperty=&ruralLifestyle=&networkProperties="
    headers = {
        'accept': '*/*',
