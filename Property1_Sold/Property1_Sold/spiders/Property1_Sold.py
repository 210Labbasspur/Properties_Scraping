...
class Property1_Sold(scrapy.Spider):
    name = 'Property1_Sold'
    prefix = 'https://www.property1group.com.au'
    # url = "https://www.property1group.com.au/propertiesJson?callback=angular.callbacks._0&currentPage=1&perPage=12&sort=d_sold%20desc&listing_cat0=residential&listing_cat1=commercial&listing_cat2=business&web_stage=sold"
    url = "https://www.property1group.com.au/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=12&sort=d_sold%20desc&listing_cat0=residential&listing_cat1=commercial&listing_cat2=business&web_stage=sold"
    headers = {
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        # 'cookie': '_gid=GA1.3.1461313674.1713705130; PHPSESSID=6c2di2pd1a58rg26rpgmviols1; _ga=GA1.3.589488579.1713705130; arp_scroll_position=400; _ga_7EX4QPBXL2=GS1.1.1713713691.2.1.1713715248.0.0.0; PHPSESSID=8o93ilerislg2goqabumnthjl1',
        'referer': 'https://www.property1group.com.au/recent-sales',
            ...
            if full_data.get('fields').get('consultants'):
                ...
                if len(full_data.get('fields').get('consultants')) == 3:
                    ...
                    if agent3:
                        ...
                        agent3_mobile = agent3.css(".phone a ::text").get('').strip()
