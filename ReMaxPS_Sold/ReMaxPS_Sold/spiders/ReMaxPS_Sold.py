...
class ReMaxPS_Sold(scrapy.Spider):
    name = "ReMaxPS_Sold"

    url = "https://www.remaxpropertysales.com.au/selling/sold-properties"
    ...
    def __init__(self, *args, **kwargs):
        super(ReMaxPS_Sold, self).__init__(*args, **kwargs)
        self.links = []
