...
class AllPropertiesGroup_Rent(scrapy.Spider):
    name = "AllPropertiesGroup_Rent"

    url = "https://allpropertiesgroup.com.au/for-rent/"
    ...
    collection = 'AllPropertiesGroup_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(AllPropertiesGroup_Rent, self).__init__(*args, **kwargs)
        self.links = []
