...
class ThompsonClarke_Sale(scrapy.Spider):
    name = 'ThompsonClarke_Sale'
    prefix = 'https://thompsonandclarke.com'
    url = "https://thompsonandclarke.com/for-sale/"
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'cache-control': 'max-age=0',
        # 'cookie': '_gcl_au=1.1.1226259476.1713299733; _gid=GA1.2.1458266371.1713430864; undefined=null; _ga_VDBS1B52QV=GS1.1.1713430864.2.1.1713430873.51.0.0; _ga=GA1.2.1821368985.1713299735; arp_scroll_position=600',
        'priority': 'u=0, i',
    ...
    count = 1
    db = 'ThompsonClarke'
    collection = 'ThompsonClarke_Sale'
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Thompson and Clarke'
