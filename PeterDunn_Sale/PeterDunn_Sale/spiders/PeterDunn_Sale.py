...
class PeterDunn_Sale(scrapy.Spider):
    name = 'PeterDunn_Sale'
    prefix = 'https://peterdunn.com.au'
    url = "https://peterdunn.com.au/listings?saleOrRental=Sale&status=available_under_contract&sortby=dateListed-desc&type=Residential"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Peter Dunn Real Estate'
