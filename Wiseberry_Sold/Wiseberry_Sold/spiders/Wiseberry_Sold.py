...
class Wiseberry_Sold(scrapy.Spider):
    name = "Wiseberry_Sold"

    url = "https://wiseberry.com.au/listings/sold?&page={}&limit=9"
    ...
    def __init__(self, *args, **kwargs):
        super(Wiseberry_Sold, self).__init__(*args, **kwargs)
        self.links = []
