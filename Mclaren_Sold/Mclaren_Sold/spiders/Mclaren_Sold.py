...
class Mclaren_Sold(scrapy.Spider):
    name = 'Mclaren_Sold'
    ...
    headers = {
        ...
        'Referer': 'https://www.mclarenrealestate.com.au/sold',
        'sec-ch-ua-mobile': '?0',
    ...
    json_data = {
        'page': 1,      'limit': 8,        'adaAgent': True,        'status': 'SOLD',        'orderBy': 'SOLD_DATE_DESC',
        }

    count = 1
    db = 'Mclaren'
    collection = 'Mclaren_Sold'
