...
class Ballarat_Sale(scrapy.Spider):
    name = "Ballarat_Sale"

    url = "https://www.ballaratrealestate.com.au/buy/property-search/"
    ...
    def __init__(self, *args, **kwargs):
        super(Ballarat_Sale, self).__init__(*args, **kwargs)
        self.links = []
