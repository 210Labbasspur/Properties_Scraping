...
class Gatton_Sold(scrapy.Spider):
    name = "Gatton_Sold"
    url = "https://gattonrealestate.com.au/listings/?page=1&saleOrRental=Sale&rental_period=week&status=sold&viewType=gallery&sortby=saleDate-desc"
    ...
    def __init__(self, *args, **kwargs):
        super(Gatton_Sold, self).__init__(*args, **kwargs)
        self.links = []
