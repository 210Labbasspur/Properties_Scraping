...
class TheBeaches_Sale(scrapy.Spider):
    name = "TheBeaches_Sale"
    url = 'https://www.thebeachesrealestate.com.au/buy/'
    ...
    def __init__(self, *args, **kwargs):
        super(TheBeaches_Sale, self).__init__(*args, **kwargs)
        self.links = []
