...
class CobdenHayson_Rent(scrapy.Spider):
    name = "CobdenHayson_Rent"

    url = "https://www.ch.com.au/for-lease/"
    ...
    def __init__(self, *args, **kwargs):
        super(CobdenHayson_Rent, self).__init__(*args, **kwargs)
        self.links = []
