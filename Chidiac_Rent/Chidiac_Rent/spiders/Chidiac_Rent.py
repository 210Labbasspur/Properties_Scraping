...
class Chidiac_Rent(scrapy.Spider):
    name = 'Chidiac_Rent'
    prefix = 'https://chidiacrealty.com.au'
    url = "https://chidiacrealty.com.au/properties-for-lease"
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'cache-control': 'max-age=0',
        # 'cookie': '_gcl_au=1.1.1740159258.1713705569; hubspotutk=67b9d954eea98641d3c26444a017e62e; _gid=GA1.3.1332368162.1714076973; VID=154566; UserOID=5a3e9a4281fa80cbd7b35c303a7288f9; __hstc=129274579.67b9d954eea98641d3c26444a017e62e.1713705571444.1714082391288.1714135808828.4; __hssrc=1; _ga=GA1.3.1309561848.1713705570; _ga_YTZ2JY5GEN=GS1.1.1714135806.4.1.1714135857.9.0.0; __hssc=129274579.3.1714135808828; arp_scroll_position=28952',
        'priority': 'u=0, i',
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field6'] = response.xpath("//*[contains(@alt,'Bedrooms')]/following-sibling::span[1]/text()").get('').strip()
            item['Field7'] = response.xpath("//*[contains(@alt,'Bathrooms')]/following-sibling::span[1]/text()").get('').strip()
            item['Field8'] = response.xpath("//*[contains(@alt,'Parking')]/following-sibling::span[1]/text()").get('').strip()

            # sold_price = response.css('.propertyPage-pricetext ::text').get('').strip().replace(' ','')
            # if sold_price:
            ...
            Agent_Imagess = response.xpath("//div[contains(@data-class-toggle,'active')]/img/@src").getall()
            new_img_urls = []
