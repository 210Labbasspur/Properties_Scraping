...
class SpencerServi_Sold(scrapy.Spider):
    name = 'SpencerServi_Sold'
    prefix = 'https://www.spencerservi.com.au'
    url = "https://www.spencerservi.com.au/sold-properties"
    headers = {
    ...
    def parse(self, response):
        for property in response.css("a.block"):
