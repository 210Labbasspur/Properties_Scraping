...
class BCM_Rent(scrapy.Spider):
    name = 'BCM_Rent'
    prefix = 'https://www.bcmproperty.com.au'
    url = "https://www.bcmproperty.com.au/leasing/properties-for-lease/"
    headers = {
        'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'Accept-Language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'Cache-Control': 'max-age=0',
        'Connection': 'keep-alive',
        # 'Cookie': '_ga=GA1.1.1374869251.1711540344; _ga_4RCNN9S310=GS1.1.1711540344.1.1.1711540435.0.0.0; arp_scroll_position=400',
        'Referer': 'https://www.bcmproperty.com.au/selling/recent-sales/',
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            car = response.xpath("//label[contains(text(),'Car Spaces')]/following-sibling::div/text()").get('').strip()
            if car:
            ...
            new_img_urls = response.xpath("//*[contains(@class,'img-orientation img-orientation-landscape img-default-used-size-large')]/@src").getall()
            ...
            agent1 = response.css('.flex-column:nth-child(1)')
            ...
            if agent1_name:
                ...
                agent1_phone = (agent1.xpath(".//*[contains(@class,'phone mb-0')]/a/@href").get('').strip()).replace('tel:','')
                item['Field20'] = (agent1.xpath(".//*[contains(@class,'phone mb-0')]/a/@href").get('').strip()).replace('tel:','')   # agent_mobile_1
                item['Field21'] = (agent1.xpath(".//*[contains(@class,'mobile mb-0')]/a/@href").get('').strip()).replace('tel:','')   # agent_mobile_1
                '''         Uploading Images on Wasabi S3 Bucket            '''
            ...
            agent2 = response.css('.flex-column:nth-child(2)')
            ...
            if agent2:
                ...
                agent2_phone = (agent2.xpath(".//*[contains(@class,'phone mb-0')]/a/@href").get('').strip()).replace('tel:','')   # agent_mobile_2
            ...
            land_area = response.xpath("//label[contains(text(),'Land Size')]/following-sibling::div/text()").get('').strip()   # external_property_id
            if land_area:
