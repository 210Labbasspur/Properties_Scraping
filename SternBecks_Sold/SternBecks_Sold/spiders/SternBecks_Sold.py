...
class SternBecks_Sold(scrapy.Spider):
    name = 'SternBecks_Sold'
    prefix = 'https://www.globalproperty.net.au'
    # url = ("https://sternbecks.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bpost_type%5D%5Btype%5D=equal&query%5Bcount%5D%5Bvalue%5D=20&query%5Bcount%5D%5Btype%5D=equal&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Borderby%5D%5Btype%5D=equal&query%5Bmeta_key%5D%5Bvalue%5D=saleDate&query%5Bmeta_key%5D%5Btype%5D=equal&query%5Bsold%5D%5Bvalue%5D=1&query%5Bsold%5D%5Btype%5D=equal&query%5BsaleOrRental%5D%5Bvalue%5D=Sale&query%5BsaleOrRental%5D%5Btype%5D=equal&"
    #        "query%5Bpaged%5D%5Bvalue%5D=1&query%5Bpaged%5D%5Btype%5D=equal&query%5Bextended%5D%5Bvalue%5D=0&query%5Bextended%5D%5Btype%5D=equal")
    url = ("https://sternbecks.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bpost_type%5D%5Btype%5D=equal&query%5Bcount%5D%5Bvalue%5D=20&query%5Bcount%5D%5Btype%5D=equal&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Borderby%5D%5Btype%5D=equal&query%5Bmeta_key%5D%5Bvalue%5D=saleDate&query%5Bmeta_key%5D%5Btype%5D=equal&query%5Bsold%5D%5Bvalue%5D=1&query%5Bsold%5D%5Btype%5D=equal&query%5BsaleOrRental%5D%5Bvalue%5D=Sale&query%5BsaleOrRental%5D%5Btype%5D=equal&"
           "query%5Bpaged%5D%5Bvalue%5D={}&query%5Bpaged%5D%5Btype%5D=equal&query%5Bextended%5D%5Bvalue%5D=0&query%5Bextended%5D%5Btype%5D=equal")
    headers = {
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'content-length': '0',
        # 'cookie': '_gid=GA1.3.1462628789.1713700425; _gcl_au=1.1.27948247.1713700425; _ga=GA1.1.469190796.1713700425; _ga_67P859NBLX=GS1.3.1713780532.2.0.1713780532.60.0.0; _ga_LJ3QB6FX5S=GS1.1.1713780532.3.1.1713781049.0.0.0',
        'origin': 'https://sternbecks.com.au',
        'priority': 'u=1, i',
        'referer': 'https://sternbecks.com.au/listings/?post_type=listings&count=20&orderby=meta_value&meta_key=saleDate&sold=1&saleOrRental=Sale&paged=1&extended=0',
