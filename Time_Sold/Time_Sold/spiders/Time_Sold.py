...
class Time_Sold(scrapy.Spider):
    name = 'Time_Sold'
    prefix = 'https://www.timerealty.com.au'
    pre_url = 'https://www.timerealty.com.au/sell/sold/'
    url = ("https://www.timerealty.com.au/wp-content/plugins/zoorealty/display/elements/load_listings.php?status=2&list=sale&order=&order_direction=&property_type=&suburb=&keywords=&price_min=&price_max=&bedrooms=&bathrooms=&carspaces=&sur_suburbs=&"
           "page={}")
    headers = {
