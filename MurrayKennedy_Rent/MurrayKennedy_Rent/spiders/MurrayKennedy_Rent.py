...
class MurrayKennedy_Rent(scrapy.Spider):
    name = 'MurrayKennedy_Rent'
    prefix = 'https://murraykennedyrealestate.com.au'
    url = "https://murraykennedyrealestate.com.au/listings/?saleOrRental=Rental&type=Residential&order=dateListed-desc"
    headers = {
