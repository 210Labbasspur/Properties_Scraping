...
class SN_Rent(scrapy.Spider):
    name = 'SN_Rent'
    prefix = 'https://www.steannicholls.com.au'
    url = "https://www.steannicholls.com.au/ajax-search-listings?direction=desc&order=date_listed&page={}&property_type=Residential&type=Rent"
    headers = {
        'accept': '*/*',
