...
class NoelJones_Rent(scrapy.Spider):
    name = "NoelJones_Rent"
    url = 'https://noeljones.com.au/rent/?property_type=&listing_type=lease%2Cboth&per_page=12&property_status=Available&surrounding=&agent_id=&pg={}&1737529579154'
    ...
    def __init__(self, *args, **kwargs):
        super(NoelJones_Rent, self).__init__(*args, **kwargs)
        self.links = []
