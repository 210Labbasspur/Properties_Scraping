...
class Mulligan_Sold(scrapy.Spider):
    name = 'Mulligan_Sold'
    prefix = 'https://www.mulliganproperty.com.au'
    url = ("https://www.mulliganproperty.com.au/data/results/?listing_sale_method=Sale&listing_status=sold&gclid=Cj0KCQjwiMmwBhDmARIsABeQ7xSHmz9TEjo6I5hwxwVWJoFJNviqbvX7q7ITv6IxGamgogIPeTTGOEgaAiiEEALw_wcB&"
           "status=sold&gad_source=1&gallery=1&pg={}")
    headers = {
        'accept': '*/*',
    ...
    count = 1
    db = 'Mulligan'
    collection = 'Mulligan_Sold'
    bucket_prefix = f'D_{collection}'

    def start_requests(self):
        yield scrapy.Request(url='https://www.mulliganproperty.com.au/sold', callback=self.parse, headers=self.headers)
