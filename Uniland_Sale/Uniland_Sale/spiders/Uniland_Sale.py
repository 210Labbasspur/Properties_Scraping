...
class Uniland_Sale(scrapy.Spider):
    name = 'Uniland_Sale'
    prefix = 'https://www.uniland.com.au'
    url = 'https://www.uniland.com.au/wp-admin/admin-ajax.php'
    headers = {
        'accept': '*/*',
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Uniland Real Estate'
