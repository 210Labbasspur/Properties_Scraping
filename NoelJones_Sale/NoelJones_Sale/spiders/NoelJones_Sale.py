...
class NoelJones_Sale(scrapy.Spider):
    name = "NoelJones_Sale"
    url = 'https://noeljones.com.au/buy/?property_type=&listing_type=sale%2Cboth&per_page=12&property_status=Available&surrounding=&agent_id=&pg={}&1737529554671=&1737529563620'
    ...
    def __init__(self, *args, **kwargs):
        super(NoelJones_Sale, self).__init__(*args, **kwargs)
        self.links = []
