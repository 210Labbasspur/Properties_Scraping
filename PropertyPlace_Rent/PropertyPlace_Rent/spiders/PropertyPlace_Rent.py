...
class PropertyPlace_Rent(scrapy.Spider):
    name = "PropertyPlace_Rent"

    url = "https://propertyplace.agency/real-estate/rent-residential-properties/"
    ...
    count = 1
    db = 'PropertyPlace'
    collection = 'PropertyPlace_Sale'
    bucket_prefix = f'PP_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(PropertyPlace_Rent, self).__init__(*args, **kwargs)
        self.links = []
