...
class OsbornGeorge_Sale(scrapy.Spider):
    name = 'OsbornGeorge_Sale'
    prefix = 'https://www.osborngeorge.com.au'
    url = "https://www.osborngeorge.com.au/wp-content/themes/ap-ljhookerraymond/zoorealty/display/elements/load_listings.php"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            # sold_price = response.xpath("//*[contains(@class,'description')]/preceding-sibling::h3[1]/text()").get('').strip().replace('$','').replace(' ','')
