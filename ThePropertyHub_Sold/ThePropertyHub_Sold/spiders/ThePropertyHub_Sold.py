...
class ThePropertyHub_Sold(scrapy.Spider):
    name = "ThePropertyHub_Sold"

    url = "https://www.thepropertyhub.com.au/recently-sold/"
    ...
    count = 1
    db = 'ThePropertyHub'
    collection = 'ThePropertyHub_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(ThePropertyHub_Sold, self).__init__(*args, **kwargs)
        self.links = []
