...
class WhiteRhino_Rent(scrapy.Spider):
    name = 'WhiteRhino_Rent'
    prefix = 'https://www.whiterhinoproperty.com.au'
    url = "https://www.whiterhinoproperty.com.au/leasing/properties-for-lease/"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'White Rhino Property'
