...
class BrianMark_Sold(scrapy.Spider):
    name = "BrianMark_Sold"
    url = 'https://www.brianmark.com.au/wp-json/api/listings/all?priceRange=&category=&type=property&status=sold&paged={}&limit=19&address=&bed=&bath=&car=&sort='
    ...
    def __init__(self, *args, **kwargs):
        super(BrianMark_Sold, self).__init__(*args, **kwargs)
        self.links = []
