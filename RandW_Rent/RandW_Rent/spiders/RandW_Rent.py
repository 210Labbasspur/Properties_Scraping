...
class RandW_Rent(scrapy.Spider):
    name = 'RandW_Rent'
    prefix = 'https://www.randw.com.au'
    url = 'https://www.randw.com.au/property-for-lease.html'
    headers = {
        'accept': '*/*',
    ...
    count = 1
    db = 'RandW'
    collection = 'RandW_Rent'
    bucket_prefix = f'D_{collection}'

    def start_requests(self):
        property_no = 0
        payload = deepcopy(self.data)
        payload['30[offset]'] = str(property_no)
    ...
    def parse(self, response):
        ...
        for property in response.xpath("//*[contains(text(),'/residential-for-lease')]"):
            property_no += 1
