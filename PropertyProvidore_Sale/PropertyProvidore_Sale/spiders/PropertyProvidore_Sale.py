...
class PropertyProvidore_Sale(scrapy.Spider):
    name = "PropertyProvidore_Sale"

    url = "https://propertyprovidore.com.au/listings?page=1&saleOrRental=Sale&rental_period=week&status=available_under_contract&viewType=gallery&sortby=dateListed-desc"
    ...
    collection = 'PropertyProvidore_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(PropertyProvidore_Sale, self).__init__(*args, **kwargs)
        self.links = []
