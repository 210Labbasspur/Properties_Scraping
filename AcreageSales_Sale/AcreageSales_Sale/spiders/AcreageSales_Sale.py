...
class AcreageSales_Sale(scrapy.Spider):
    name = 'AcreageSales_Sale'
    prefix = 'https://www.acreagesales.com.au'
    url = "https://www.acreagesales.com.au/buy/all-real-estate-property-for-sale/"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Acreage Sales - United Realty'
            ...
            # sold_price = response.xpath("//*[contains(@class,'property-type')]/text()").get('').strip()
