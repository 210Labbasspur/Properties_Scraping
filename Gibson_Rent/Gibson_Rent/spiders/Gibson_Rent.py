...
class Gibson_Rent(scrapy.Spider):
    name = 'Gibson_Rent'
    prefix = 'https://www.gibsonpartners.com'
    url = "https://www.gibsonpartners.com/renting/properties-for-lease/"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Gibson Partners In Property'
