...
class PropertyProvidore_Sold(scrapy.Spider):
    name = "PropertyProvidore_Sold"

    url = "https://propertyprovidore.com.au/listings/?saleOrRental=Sale&rental_period=week&status=sold&viewType=gallery&sortby=saleDate-desc&page=1"
    ...
    collection = 'PropertyProvidore_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(PropertyProvidore_Sold, self).__init__(*args, **kwargs)
        self.links = []
