...
class Dougherty_Sale(scrapy.Spider):
    name = "Dougherty_Sale"
    ...
    url = "https://doughertyproperty.com.au/pages/real-estate/results?widgetKey=218643&context=listings&returnAs=markup&listing_sale_method=Sale&display_sale_method=BUY&pg={}"
    ...
    def __init__(self, *args, **kwargs):
        super(Dougherty_Sale, self).__init__(*args, **kwargs)
        self.links = []
