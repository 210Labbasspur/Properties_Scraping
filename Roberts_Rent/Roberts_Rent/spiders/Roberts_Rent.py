...
'''
        rentals = []
        for all_p in response.xpath("//*[contains(@class,'rental type-rental status-publish')]"):
            if all_p.xpath(".//*[contains(@class,'status-sticker leased')]"):
                ...
                rentals.append(all_p.css('.epl-archive-entry-image a::attr(href)').get('').strip())
'''
##################          Roberts_Rent
...
class Roberts_Rent(scrapy.Spider):
    name = "Roberts_Rent"
    ...
    def __init__(self, *args, **kwargs):
        super(Roberts_Rent, self).__init__(*args, **kwargs)
        self.links = []
