...
class Mulligan_Sale(scrapy.Spider):
    name = 'Mulligan_Sale'
    prefix = 'https://www.mulliganproperty.com.au'
    url = ("https://www.mulliganproperty.com.au/data/results/?listing_sale_method=Sale&listing_status=sale&gclid=Cj0KCQjwiMmwBhDmARIsABeQ7xSHmz9TEjo6I5hwxwVWJoFJNviqbvX7q7ITv6IxGamgogIPeTTGOEgaAiiEEALw_wcB&"
           "status=sale&gad_source=1&gallery=1&pg={}")
    headers = {
        'accept': '*/*',
    ...
    count = 1
    db = 'Mulligan'
    collection = 'Mulligan_Sale'
    bucket_prefix = f'D_{collection}'

    def start_requests(self):
        yield scrapy.Request(url='https://www.mulliganproperty.com.au/residential/sale', callback=self.parse, headers=self.headers)
