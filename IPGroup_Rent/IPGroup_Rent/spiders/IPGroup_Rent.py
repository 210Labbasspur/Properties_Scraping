...
class IPGroup_Rent(scrapy.Spider):
    name = 'IPGroup_Rent'
    prefix = 'https://www.theipgroup.com.au'
    url = 'https://www.theipgroup.com.au/properties-for-lease'
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'cache-control': 'max-age=0',
        # 'cookie': 'AMP_MKTG_16a5c84b5b=JTdCJTdE; _gid=GA1.3.469297839.1711837645; PROTOCID=coob6vpeusp573ndee6fsbg0s4; AMP_16a5c84b5b=JTdCJTIyZGV2aWNlSWQlMjIlM0ElMjJiZTM2MDQ4ZS0yMDA3LTQzYzAtYmFjZi00YjY3N2FiMDZmYWYlMjIlMkMlMjJzZXNzaW9uSWQlMjIlM0ExNzEyMDAzMzA1NjE5JTJDJTIyb3B0T3V0JTIyJTNBZmFsc2UlMkMlMjJsYXN0RXZlbnRUaW1lJTIyJTNBMTcxMjAwMzMwNTgzOSU3RA==; _ga_5D65ZN95FB=GS1.1.1712003306.4.0.1712003306.0.0.0; _ga=GA1.1.711865880.1711837645; arp_scroll_position=200',
    ...
    def start_requests(self):
        ...
        # yield scrapy.Request(url='https://www.theipgroup.com.au/leased-properties', headers=self.headers, callback=self.parse)
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            property_add = response.css('.text-left-sml div ::text').getall()  # full_adddress
            ...
            description = response.css('#site-main p ::text, h2 ::text').getall()  # description
