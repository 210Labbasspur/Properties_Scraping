...
class ToorbulDistrict_Sale(scrapy.Spider):
    name = "ToorbulDistrict_Sale"

    url = "https://toorbuldistrictrealty.com.au/properties/"
    ...
    count = 1
    db = 'ToorbulDistrict'
    collection = 'ToorbulDistrict_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(ToorbulDistrict_Sale, self).__init__(*args, **kwargs)
        self.links = []
