...
class Rubinstein_Sale(scrapy.Spider):
    name = 'Rubinstein_Sale'
    prefix = 'https://www.therubinsteingroup.com'
    url = 'https://www.therubinsteingroup.com/sales/'
    headers = {
    ...
    def start_requests(self):
        ...
        driver.get('https://www.therubinsteingroup.com/sales/')
        time.sleep(2)
        ...
        for property in response.xpath("//a[contains(@class,'card card--property')]"):
            if property.xpath(".//span[contains(text(),'sold')]"):
                pass
            else:
