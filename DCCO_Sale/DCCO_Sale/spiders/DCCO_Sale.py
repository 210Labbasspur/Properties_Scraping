...
class DCCO_Sale(scrapy.Spider):
    name = 'DCCO_Sale'
    prefix = 'https://www.dcco.com.au'
    url = ("https://www.dcco.com.au/search/?show_in_residential=true&show_in_sale=true&sold=0&order_by=listing_date&order=desc")
    headers = {
