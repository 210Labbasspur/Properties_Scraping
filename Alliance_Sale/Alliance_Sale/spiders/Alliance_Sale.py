...
class Alliance_Sale(scrapy.Spider):
    name = 'Alliance_Sale'
    prefix = 'https://www.allianceaust.com.au'
    url = 'https://www.allianceaust.com.au/wp-admin/admin-ajax.php'
    headers = {
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
        # 'cookie': '_ga_GR3KTFG7Y8=GS1.1.1715632676.1.0.1715632676.0.0.0; _ga=GA1.1.880104269.1715632677; arp_scroll_position=1000',
        # 'origin': 'https://www.allianceaust.com.au',
        'priority': 'u=1, i',
        # 'referer': 'https://www.allianceaust.com.au/selling/recent-sales/',
    ...
    def parse(self, response):
        ...
        for property in data['data']['props']:
            ...
            mini_data['car'] = 0
            if property.get('garage'):
                mini_data['car'] = int(property.get('garage'))
            if property.get('carport'):
                mini_data['car'] = mini_data['car'] + int(property.get('carport'))
            if property.get('off_street_park'):
                mini_data['car'] = mini_data['car'] + int(property.get('off_street_park'))
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Alliance Real Estate'
            ...
            Agent_Imagess = response.xpath("//*[contains(@class,'embed-responsive embed-responsive-2by3')]/picture/source/img/@src").getall()
            new_img_urls = []
            ...
            if response.css(".listing-agent"):
                ...
                if agent1_name:
                    ...
                    item['Field18'] = agent1.css(".role  a ::text").get('').strip()  # agent_full_name_1
                ...
                if len(response.css(".listing-agent").getall()) > 1:
                    ...
                    if agent2:
                        ...
                        item['Field24'] = agent2.css(".role  a ::text").get('').strip()  # agent_full_name_1
                ...
                if len(response.css(".listing-agent").getall()) > 2:
                    ...
                    if agent3:
                        ...
                        item['Field29'] = agent3.css(".role  a ::text").get('').strip()  # agent_full_name_1
