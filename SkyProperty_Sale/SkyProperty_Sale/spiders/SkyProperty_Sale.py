...
class SkyProperty_Sale(scrapy.Spider):
    name = "SkyProperty_Sale"

    url = "https://www.skyproperty.com.au/buying/properties-for-sale/"
    ...
    count = 1
    db = 'SkyProperty'
    collection = 'SkyProperty_Sale'
    bucket_prefix = f'SkyProperty_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(SkyProperty_Sale, self).__init__(*args, **kwargs)
        self.links = []
