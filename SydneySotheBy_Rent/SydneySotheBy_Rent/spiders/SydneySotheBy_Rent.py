...
class SydneySotheBy_Rent(scrapy.Spider):
    name = 'SydneySotheBy_Rent'
    prefix = 'https://sydneysothebysrealty.com'
    url = "https://sydneysothebysrealty.com/properties-for-lease"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Sydney SotheBy\'s International Realty'
            ...
            description = response.css('.propertyPage-property-description p ::text').getall()  # description
