...
class PeterDunn_Rent(scrapy.Spider):
    name = 'PeterDunn_Rent'
    prefix = 'https://peterdunn.com.au'
    url = "https://peterdunn.com.au/listings?saleOrRental=Rental&status=available_under_contract&sortby=dateListed-desc"
    headers = {
