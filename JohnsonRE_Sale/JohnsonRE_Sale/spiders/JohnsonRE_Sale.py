...
class JohnsonRE_Sale(scrapy.Spider):
    name = "JohnsonRE_Sale"

    url = "https://www.johnsonre.com.au/buying?203695f3_page=1"
    ...
    def __init__(self, *args, **kwargs):
        super(JohnsonRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
