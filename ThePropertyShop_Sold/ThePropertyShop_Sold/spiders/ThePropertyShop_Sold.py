...
class ThePropertyShop_Sold(scrapy.Spider):
    name = 'ThePropertyShop_Sold'
    prefix = 'https://www.thepropertyshop.com.au'
    url = "https://www.thepropertyshop.com.au/selling/recent-sales/"
    headers = {
    ...
    count = 1
    db = 'ThePropertyShop'
    collection = 'ThePropertyShop_Sold'
