...
class Harwood_Sold(scrapy.Spider):
    name = "Harwood_Sold"

    url = "https://www.harwoodproperty.com.au/recent-sales/page/1/"
    ...
    def __init__(self, *args, **kwargs):
        super(Harwood_Sold, self).__init__(*args, **kwargs)
        self.links = []
