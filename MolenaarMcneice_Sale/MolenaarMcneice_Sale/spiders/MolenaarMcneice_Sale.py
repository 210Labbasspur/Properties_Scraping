...
class MolenaarMcneice_Sale(scrapy.Spider):
    name = 'MolenaarMcneice_Sale'
    prefix = 'https://www.mmproperty.com.au'
    url = "https://www.mmproperty.com.au/wp-json/api/listings/all?priceRange=&type=property&status=current&paged={}&limit=12&address=&bed=&bath=&car=&sort="
    headers = {
        'accept': '*/*',
    ...
    count = 1
    db = 'MolenaarMcneice'
    collection = 'MolenaarMcneice_Sale'
