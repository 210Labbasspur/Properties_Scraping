...
class Broadhurst_Sale(scrapy.Spider):
    name = "Broadhurst_Sale"

    url = "https://www.broadhurstproperty.com.au/for-sale/"
    ...
    def __init__(self, *args, **kwargs):
        super(Broadhurst_Sale, self).__init__(*args, **kwargs)
        self.links = []
