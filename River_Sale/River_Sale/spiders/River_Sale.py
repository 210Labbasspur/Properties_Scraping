...
class River_Sale(scrapy.Spider):
    name = 'River_Sale'
    prefix = 'https://presence.realestate'
    # url = "https://www.riverrealty.com.au/wp-json/api/listings/all?priceRange=&category=&type=property&status=current&paged=1&limit=20&address=&bed=&bath=&car=&sort="
    url = "https://www.riverrealty.com.au/wp-json/api/listings/all?priceRange=&category=&type=property&status=current&paged={}&limit=20&address=&bed=&bath=&car=&sort="
    headers = {
        'accept': 'application/json, text/plain, */*',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        # 'cookie': 'cf_clearance=EjbYmWhCvrm0VXT3vo0k648DZrZxV.gdkHjgnXWRrjo-1713250019-1.0.1.1-FFccAwRWpIdHVNGXK4aE2XgB0v0_5eNkEJ9ONXwMrpa.z9gPPUUCqx1xgvDsQiuR1XTSmS8gY5_VaM4mhfwOIw; afl_wc_utm_cookie_expiry=90; afl_wc_utm_sess_visit=1713250046; afl_wc_utm_sess_landing=https%3A%2F%2Fwww.riverrealty.com.au%2Frecent-sales%2F; afl_wc_utm_utm_1st_url=https%3A%2F%2Fwww.riverrealty.com.au%2Frecent-sales%2F%3Futm_source%3Ddirect%26utm_medium%3Dnone; afl_wc_utm_utm_1st_visit=1713250046; afl_wc_utm_utm_url=https%3A%2F%2Fwww.riverrealty.com.au%2Frecent-sales%2F%3Futm_source%3Ddirect%26utm_medium%3Dnone; afl_wc_utm_utm_visit=1713250046; afl_wc_utm_main=%7B%22updated_ts%22%3A1713250049%7D; _gid=GA1.3.454379123.1713640312; _gat_gtag_UA_16646507_15=1; _ga_6LN106PMHL=GS1.1.1713644989.3.1.1713646592.0.0.0; _ga_N2V2J25TYW=GS1.1.1713644988.3.1.1713646594.0.0.0; _ga=GA1.1.1430116198.1713250042',
        'priority': 'u=1, i',
        # 'referer': 'https://www.riverrealty.com.au/recent-sales/',
    ...
    def parse(self, response):
        ...
        for property in data['results']:
            ...
            mini_data = dict()
            mini_data['address'] = property.get('address').get('fullAddress')
            mini_data['bed'] = property.get('bedrooms')
            mini_data['bath'] = property.get('bathrooms')
            mini_data['car'] = property.get('parkingSpaces')
            mini_data['sold_price'] = property.get('price').get('value').replace('$','').replace('SOLD','')
            mini_data['property_type'] = property.get('categories')
        ...
        if not DB_already_exists:
            ...
            if full_data['agent']:
                ...
                if agent1:
                    ...
                    agent1_phone = agent1.get('mobile')
                    item['Field20'] = agent1_phone.strip()
                    item['Field21'] = agent1.get('phone')
                    '''         Uploading Images on Wasabi S3 Bucket            '''
                    Agent_Images = agent1.get('avatar')
            ...
            feature_count = 58
            for feature in response.css(".listing-single__features-items span"):
