...
class Denovans_Rent(scrapy.Spider):
    name = "Denovans_Rent"
    url = 'https://denovans.com.au/wp-json/api/listings/all?suburbsSurrounding=&priceRange=&category=&type=rental&status=current&paged={}&limit=16&address=&bed=&bath=&car=&sort='
    ...
    def __init__(self, *args, **kwargs):
        super(Denovans_Rent, self).__init__(*args, **kwargs)
        self.links = []
