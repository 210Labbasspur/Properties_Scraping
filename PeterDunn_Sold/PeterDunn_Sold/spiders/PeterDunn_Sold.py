...
class PeterDunn_Sold(scrapy.Spider):
    name = 'PeterDunn_Sold'
    prefix = 'https://peterdunn.com.au'
    url = "https://peterdunn.com.au/listings/?status=sold&saleOrRental=Sale&viewType=gallery&sortby=saleDate-desc"
    headers = {
