...
class Waratah_Sale(scrapy.Spider):
    name = "Waratah_Sale"

    url = "https://www.waratahestateagents.com.au/properties-for-sale/"
    ...
    count = 1
    db = 'Waratah'
    collection = 'Waratah_Sale'
    bucket_prefix = f'WEA_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(Waratah_Sale, self).__init__(*args, **kwargs)
        self.links = []
