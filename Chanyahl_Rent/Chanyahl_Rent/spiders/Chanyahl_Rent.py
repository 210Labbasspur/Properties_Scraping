...
class Chanyahl_Rent(scrapy.Spider):
    name = 'Chanyahl_Rent'
    prefix = 'https://chanyahl.com.au'
    url = "https://chanyahl.com.au/wp-json/api/listings/all?priceRange=&limit=12&type=rental&status=current&address=&paged={}&bed=&bath=&car=&sort=&homeLand=&landProperty=&ruralLifestyle=&networkProperties="
    headers = {
        'accept': '*/*',
