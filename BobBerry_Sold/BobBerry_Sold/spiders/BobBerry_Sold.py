...
class BobBerry_Sold(scrapy.Spider):
    name = 'BobBerry_Sold'
    prefix = 'https://www.bobberry.com.au'
    url = "https://www.bobberry.com.au/selling/sold-properties/"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Bob Berry Real Estate'
            ...
            item['Field6'] = ''.join(element.strip() for element in response.css("#quickinfo .bedroom ::text").getall())  # description
            item['Field7'] = ''.join(element.strip() for element in response.css("#quickinfo .bathroom ::text").getall())  # description
            item['Field8'] = ''.join(element.strip() for element in response.css("#quickinfo .carspace ::text").getall())  # description

            sold_price = response.css('.price .price__label ::text').get('').strip().replace('Sold','').replace(' ','')
            ...
            '''          AGENTS          '''
            if response.css(".agent-photo-wrapper"):
                agent1 = response.css(".agent-photo-wrapper")[0]
                ...
                if agent1_name:
                    ...
                    agent1_mobile = agent1.css(".agent-info-item-phone+ .px-2 a ::attr(href)").get('').strip().replace('tel:','')
                ...
                if len(response.css(".agent-photo-wrapper").getall()) > 1:
                    agent2 = response.css(".agent-photo-wrapper")[1]
                    ...
                    if agent2:
                        ...
                        agent2_mobile = agent2.css(".agent-info-item-phone+ .px-2 a ::attr(href)").get('').strip().replace('tel:','')
                ...
                if len(response.css(".agent-photo-wrapper").getall()) > 2:
                    agent3 = response.css(".agent-photo-wrapper")[2]
                    ...
                    if agent3:
                        ...
                        agent3_mobile = agent3.css(".agent-info-item-phone+ .px-2 a ::attr(href)").get('').strip().replace('tel:','')
