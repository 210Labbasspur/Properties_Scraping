...
class Butterfield_Sale(scrapy.Spider):
    name = 'Butterfield_Sale'
    prefix = 'https://www.butterfieldproperty.com.au'
    url = "https://www.butterfieldproperty.com.au/buying/properties-for-sale/"
    headers = {
