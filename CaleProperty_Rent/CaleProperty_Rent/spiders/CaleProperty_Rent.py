...
class CaleProperty_Rent(scrapy.Spider):
    name = "CaleProperty_Rent"

    url = "https://www.caleproperty.com.au/for-rent/property-search"
    ...
    count = 1
    db = 'CaleProperty'
    collection = 'CaleProperty_Rent'
    bucket_prefix = f'CP_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(CaleProperty_Rent, self).__init__(*args, **kwargs)
        self.links = []
