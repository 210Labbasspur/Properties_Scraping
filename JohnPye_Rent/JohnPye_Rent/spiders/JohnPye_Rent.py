...
class JohnPye_Rent(scrapy.Spider):
    name = 'JohnPye_Rent'
    prefix = 'https://www.johnpye.com.au'
    url = "https://www.johnpye.com.au/rent/properties-for-rent/"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            # Agent_Imagess = response.css("#gallery .lazyloaded ::attr(style)").getall()
