################33          DegreesRealEstateRockBank_Rent
...
class DegreesRealEstateRockBank_Rent(scrapy.Spider):
    name = "DegreesRealEstateRockBank_Rent"

    url = "https://www.361degreesrealestaterockbank.com.au/rent/"
    ...
    collection = 'DegreesRealEstateRockBank_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(DegreesRealEstateRockBank_Rent, self).__init__(*args, **kwargs)
        self.links = []
