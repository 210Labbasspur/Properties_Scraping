...
class DCCO_Rent(scrapy.Spider):
    name = 'DCCO_Rent'
    prefix = 'https://www.dcco.com.au'
    url = ("https://www.dcco.com.au/search/?show_in_residential=true&show_in_rental=true&sold=0&order_by=listing_date&order=desc")
    headers = {
