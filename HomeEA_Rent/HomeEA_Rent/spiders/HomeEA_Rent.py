...
class HomeEA_Rent(scrapy.Spider):
    name = 'HomeEA_Rent'
    prefix = 'https://www.homeea.com.au'
    url = "https://www.homeea.com.au/properties-for-lease"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Home Estate Agents'

            property_add = response.css('.propertyPage-title ::text').getall()  # full_adddress
            ...
            item['Field6'] = response.xpath("//*[contains(@class,'far fa-bed')]/preceding-sibling::p[1]/text()").get('').strip()
            item['Field7'] = response.xpath("//*[contains(@class,'far fa-bath')]/preceding-sibling::p[1]/text()").get('').strip()
            item['Field8'] = response.xpath("//*[contains(@class,'far fa-car')]/preceding-sibling::p[1]/text()").get('').strip()
            ...
            feature_count = 58
            for feature in response.xpath("//*[contains(text(),'Property Features')]/following-sibling::ul/li/span[1]"):
