...
class GaryPeer_Sale(scrapy.Spider):
    name = "GaryPeer_Sale"

    url = "https://www.garypeer.com.au/buy/search-listings?page={}&listing_type=1&add_status=1"
    ...
    def __init__(self, *args, **kwargs):
        super(GaryPeer_Sale, self).__init__(*args, **kwargs)
        self.links = []
