...
class RedProperty_Rent(scrapy.Spider):
    name = 'RedProperty_Rent'
    prefix = 'https://www.redproperty.com.au'
    url = "https://www.redproperty.com.au/lease/listings/"
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'cache-control': 'max-age=0',
        # 'cookie': '_ga=GA1.1.791391125.1713269982; _ga_2GLFCWGFXE=GS1.1.1713269981.1.1.1713269992.0.0.0; arp_scroll_position=100',
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field6'] = ' '.join(element.strip() for element in response.css(".listing-mid-section .bedroom ::text").getall())  # description
            item['Field7'] = ' '.join(element.strip() for element in response.css(".listing-mid-section .bathroom ::text").getall())  # description
            item['Field8'] = ' '.join(element.strip() for element in response.css(".listing-mid-section .carspace ::text").getall())  # description
            ...
            if agent1:
                ...
                agent1_phone = ''.join(element.strip() for element in agent1.css(".agent-info-item-phone a::text").getall())  # description
                item['Field20'] = ''.join(element.strip() for element in agent1.css(".agent-info-item-phone a::text").getall())  # description
                item['Field21'] = ''.join(element.strip() for element in agent1.css(".agent-info-item-mobile a::text").getall())  # description
                '''         Uploading Images on Wasabi S3 Bucket            '''
            ...
            if len(response.css(".listing-agent").getall()) > 1:
                ...
                if agent2:
                    ...
                    agent2_phone = ''.join(element.strip() for element in agent2.css(".agent-info-item-phone a::text").getall())  # description
                    item['Field26'] = agent2_phone.strip()  # description
                    item['Field26A'] = ''.join(element.strip() for element in agent2.css(".agent-info-item-mobile a::text").getall())  # description
                    '''         Uploading Images on Wasabi S3 Bucket            '''
            ...
            if len(response.css(".listing-agent").getall()) == 3:
                ...
                if agent3:
                    ...
                    agent3_phone = ''.join(element.strip() for element in agent3.css(".agent-info-item-phone a::text").getall())  # description
                    item['Field31'] = agent3_phone.strip()  # description
                    item['Field31A'] = ''.join(element.strip() for element in agent3.css(".agent-info-item-mobile a::text").getall())  # description
                    '''         Uploading Images on Wasabi S3 Bucket            '''
