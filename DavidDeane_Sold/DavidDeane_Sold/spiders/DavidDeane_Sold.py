...
class DavidDeane_Sold(scrapy.Spider):
    name = "DavidDeane_Sold"
    url = ('https://www.daviddeane.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bpost_type%5D%5Btype%5D=equal&query%5Bcount%5D%5Bvalue%5D=20&query%5Bcount%5D%5Btype%5D=equal&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Borderby%5D%5Btype%5D=equal&query%5Bmeta_key%5D%5Bvalue%5D=saleDate&query%5Bmeta_key%5D%5Btype%5D=equal&query%5Bsold%5D%5Bvalue%5D=1&query%5Bsold%5D%5Btype%5D=equal&query%5BsaleOrRental%5D%5Bvalue%5D=Sale&query%5BsaleOrRental%5D%5Btype%5D=equal&query'
           '%5Bpaged%5D%5Bvalue%5D={}&query%5Bpaged%5D%5Btype%5D=equal&query%5Bminprice%5D%5Bvalue%5D=0&query%5Bminprice%5D%5Btype%5D=equal&query%5Bmaxprice%5D%5Bvalue%5D=5000001&query%5Bmaxprice%5D%5Btype%5D=equal&query%5Border%5D%5Bvalue%5D=saleDate-desc&query%5Border%5D%5Btype%5D=equal&query%5Bdoing_wp_cron%5D%5Bvalue%5D=1738764600.3355560302734375000000&query%5Bdoing_wp_cron%5D%5Btype%5D=equal')
    prefix = "https://www.daviddeane.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(DavidDeane_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(3347)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'David Deane'
