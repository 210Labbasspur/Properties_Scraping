...
class CaleProperty_Sale(scrapy.Spider):
    name = "CaleProperty_Sale"

    url = "https://www.caleproperty.com.au/buy/for-sale"
    ...
    count = 1
    db = 'CaleProperty'
    collection = 'CaleProperty_Sale'
    bucket_prefix = f'CP_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(CaleProperty_Sale, self).__init__(*args, **kwargs)
        self.links = []
