...
class RealWay_Sale(scrapy.Spider):
    name = "RealWay_Sale"
    url = "https://toowoomba.realway.com.au/listings?saleOrRental=Sale&status=available_under_contract&sortby=dateListed-desc"
    prefix = "https://toowoomba.realway.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(RealWay_Sale, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://toowoomba.realway.com.au{each_url}'
        ...
        for property_url in all_links:
            property_url = f'https://toowoomba.realway.com.au{property_url}'
