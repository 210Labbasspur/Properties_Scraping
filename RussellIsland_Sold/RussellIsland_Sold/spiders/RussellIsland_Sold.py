...
class RussellIsland_Sold(scrapy.Spider):
    name = 'RussellIsland_Sold'
    prefix = 'https://www.russellislandrealestate.com.au'
    url = 'https://www.russellislandrealestate.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(RussellIsland_Sold, self).__init__(*args, **kwargs)
        self.links = []
