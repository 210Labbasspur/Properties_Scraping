...
class PropertyforYou_Rent(scrapy.Spider):
    name = "PropertyforYou_Rent"

    url = "https://property4you.com.au/listings/?page=1&saleOrRental=Rental&rental_period=week&status=available&viewType=gallery&sortby=dateListed-desc"
    prefix = "https://property4you.com.au"
    headers = {
    ...
    count = 1
    db = 'PropertyforYou'
    collection = 'PropertyforYou_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(PropertyforYou_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://property4you.com.au{each_url}'
        ...
        for property_url in all_links:
            property_url = f'https://property4you.com.au{property_url}'
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(3303)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Property4You'
