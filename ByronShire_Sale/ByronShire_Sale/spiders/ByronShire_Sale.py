...
class ByronShire_Sale(scrapy.Spider):
    name = 'ByronShire_Sale'
    prefix = 'https://www.byronshirerealestate.com.au'
    url = "https://www.byronshirerealestate.com.au/propertiesJson?callback=angular.callbacks._2&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=residential"
    headers = {
        'accept': '*/*',
    ...
    def Detail_parse(self, mini_data,full_data):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Byron Shire Real Estate'
