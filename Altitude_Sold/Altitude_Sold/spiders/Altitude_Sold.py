...
class Altitude_Sold(scrapy.Spider):
    name = 'Altitude_Sold'
    prefix = 'https://www.altituderealestate.com.au'
    url = ("https://www.altituderealestate.com.au/data/results/?listing_sale_method=Sale&listing_status=sold&sort=date-desc&"
           "status=sold&pg={}")
    headers = {
        'accept': '*/*',
    ...
    count = 1
    db = 'Altitude'
    collection = 'Altitude_Sold'
    bucket_prefix = f'D_{collection}'

    def start_requests(self):
        yield scrapy.Request(url='https://www.altituderealestate.com.au/sold', callback=self.parse, headers=self.headers)
