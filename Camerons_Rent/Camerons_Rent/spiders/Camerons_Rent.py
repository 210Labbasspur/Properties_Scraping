...
class Camerons_Rent(scrapy.Spider):
    name = 'Camerons_Rent'
    prefix = 'https://www.cameronsrealestate.com.au'
    url = "https://www.cameronsrealestate.com.au/renting/properties-for-lease/"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Camerons Real Estate'
