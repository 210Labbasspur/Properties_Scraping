...
class ParkesRealProperty_Rent(scrapy.Spider):
    name = 'ParkesRealProperty_Rent'
    prefix = 'https://www.parkesrealproperty.com.au'
    url = "https://www.parkesrealproperty.com.au/for-lease/"
    headers = {
    ...
    collection = 'ParkesRealProperty_Rent'
