...
class MD_Rent(scrapy.Spider):
    name = 'MD_Rent'
    prefix = 'https://multidynamic.com.au'
    # url = ("https://multidynamic.com.au/search-properties?category=rent&sub_category=8&type=any&location=any&bedrooms=any&bathrooms"
    #        "=any&garages=any&price_range=0%2C600000&page=1")
    url = ("https://multidynamic.com.au/search-properties?category=rent&sub_category=8&type=any&location=any&bedrooms=any&bathrooms"
