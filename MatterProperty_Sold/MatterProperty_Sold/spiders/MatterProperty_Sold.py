...
class MatterProperty_Sold(scrapy.Spider):
    name = "MatterProperty_Sold"
    url = 'https://www.matterproperty.homes/wp-admin/admin-ajax.php'
    prefix = "https://www.matterproperty.homes"
    headers = {
    ...
    count = 1
    db = 'MatterProperty'
    collection = 'MatterProperty_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(MatterProperty_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(3358)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Matter Property'
            ...
            feature_count = 58
            for feature in response.css(".description-container .col-md-6"):   ##  first 4 features are ID, bed, bath etc.
