...
class Macquarie_Sold(scrapy.Spider):
    name = 'Macquarie_Sold'
    url = "https://www.macquarierealestate.com.au/selling/recent-sales/"
    headers = {
    ...
    count = 1
    db = 'Macquarie'
    collection = 'Macquarie_Sold'
    bucket_prefix = 'D_Macquarie_Sold'
