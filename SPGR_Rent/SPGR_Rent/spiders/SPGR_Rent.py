...
class SPGR_Rent(scrapy.Spider):
    ...
    'atts[page_list]': 'Land::https://www.spgr.com.au/lease/?property_type=land,Commercial::https://www.spgr.com.au/buy/commercial-for-sale/',
    'atts[sort]': 'latest',
    'per_page': '18',
    'load_more': 'true',
    ...
    def __init__(self, *args, **kwargs):
        super(SPGR_Rent, self).__init__(*args, **kwargs)
        self.links = []
