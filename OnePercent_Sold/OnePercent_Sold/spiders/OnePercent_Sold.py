...
class OnePercent_Sold(scrapy.Spider):
    name = "OnePercent_Sold"

    url = "https://onepercent.com.au/sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(OnePercent_Sold, self).__init__(*args, **kwargs)
        self.links = []
