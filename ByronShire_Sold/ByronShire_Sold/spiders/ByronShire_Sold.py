...
class ByronShire_Sold(scrapy.Spider):
    name = 'ByronShire_Sold'
    prefix = 'https://www.byronshirerealestate.com.au'
    url = "https://www.byronshirerealestate.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold"
    headers = {
        'accept': '*/*',
