...
class ArriveHome_Sold(scrapy.Spider):
    name = "ArriveHome_Sold"
    url = "https://arrivehome.com.au/wp-json/api/listings/all?priceRange=&type=property&status=sold&paged={}&limit=16&address=&bed=&bath=&car=&sort="
    ...
    def __init__(self, *args, **kwargs):
        super(ArriveHome_Sold, self).__init__(*args, **kwargs)
        self.links = []
