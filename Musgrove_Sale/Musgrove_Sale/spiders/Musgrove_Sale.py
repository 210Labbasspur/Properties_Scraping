...
class Musgrove_Sale(scrapy.Spider):
    name = 'Musgrove_Sale'
    prefix = 'https://www.musgroverealty.com.au'
    url = "https://www.musgroverealty.com.au/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=residential"
    headers = {
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        # 'cookie': 'PHPSESSID=82d2hjucc74q253kctag65sqc4; arp_scroll_position=700',
        'referer': 'https://www.musgroverealty.com.au/recent-sales',
