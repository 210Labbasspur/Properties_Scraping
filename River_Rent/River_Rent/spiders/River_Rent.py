...
class River_Rent(scrapy.Spider):
    name = 'River_Rent'
    url = "https://www.riverrealty.com.au/wp-json/api/listings/all?priceRange=&category=&type=rental&status=current&paged={}&limit=20&address=&bed=&bath=&car=&sort="
    headers = {
