...
class TheMA_Rent(scrapy.Spider):
    name = 'TheMA_Rent'
    prefix = 'https://themanagementagency.com.au'
    url = "https://themanagementagency.com.au/listings/?pagination_id=1&instance_id=1"
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        # 'cookie': 'epl_wp_session=225a9308504e4397ebb818abb4a40e1a%7C%7C1714671155%7C%7C1714669355; arp_scroll_position=2000; epl_wp_session=225a9308504e4397ebb818abb4a40e1a%7C%7C1714671155%7C%7C1714669355',
        'priority': 'u=0, i',
        # 'referer': 'https://themanagementagency.com.au/listings/',
    ...
    def parse(self, response):
        for property in response.css(".epl-row__link"):
        ...
        next_page = response.xpath("//*[contains(@class,'current')]/following-sibling::a[1]/@href").get('').strip()
        if next_page:
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'The Management Agency'
            ...
            description = response.css('.epl-section-inner__panel--description p ::text').getall()  # description
            item['Field12'] = ' '.join(element.strip().replace('\t', ' ').replace('\xa0', ' ') for element in description)  # description

            '''         Uploading Images on Wasabi S3 Bucket            '''
            Agent_Imagess = response.css("div.epl-slider-current-slide a ::attr(href)").getall()
            new_img_urls = []
            ...
            '''          AGENTS          '''        ##      No agents available on site
