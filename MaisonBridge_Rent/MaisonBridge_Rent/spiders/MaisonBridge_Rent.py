...
class MaisonBridge_Rent(scrapy.Spider):
    name = "MaisonBridge_Rent"

    url = "https://maisonbridge.com.au/wp-admin/admin-ajax.php?action=ere_property_paging_ajax&layout=property-grid&items_amount=9&columns=3&image_size=full&columns_gap=col-gap-30&view_all_link=&paged={}&property_type=&property_status=for-rent&property_feature=&property_city=&property_state=&property_neighborhood=&property_label=&property_featured=&author_id=&agent_id="
    ...
    def __init__(self, *args, **kwargs):
        super(MaisonBridge_Rent, self).__init__(*args, **kwargs)
        self.links = []
