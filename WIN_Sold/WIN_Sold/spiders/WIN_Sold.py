...
class WIN_Sold(scrapy.Spider):
    name = "WIN_Sold"
    url = 'https://www.winrealestate.com.au/wp-json/api/listings/all?priceRange=&limit=24&type=property&status=sold&paged={}&bed=&bath=&car=&sort=newest'
    ...
    def __init__(self, *args, **kwargs):
        super(WIN_Sold, self).__init__(*args, **kwargs)
        self.links = []
