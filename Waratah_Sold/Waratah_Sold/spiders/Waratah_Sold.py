...
class Waratah_Sold(scrapy.Spider):
    name = "Waratah_Sold"

    url = "https://www.waratahestateagents.com.au/recent-sales/"
    ...
    count = 1
    db = 'Waratah'
    collection = 'Waratah_Sold'
    bucket_prefix = f'WEA_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(Waratah_Sold, self).__init__(*args, **kwargs)
        self.links = []
