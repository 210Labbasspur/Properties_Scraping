...
class Dawson_Sold(scrapy.Spider):
    name = 'Dawson_Sold'
    prefix = 'https://www.dawsonestateagents.com.au'
    url = "https://www.dawsonestateagents.com.au/sell/recent-sales?status=current&disposalMethod=sold&orderBy=sold&page=1"
    headers = {
