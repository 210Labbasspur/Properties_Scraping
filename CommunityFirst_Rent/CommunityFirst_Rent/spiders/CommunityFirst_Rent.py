...
class CommunityFirst_Rent(scrapy.Spider):
    name = "CommunityFirst_Rent"

    url = "https://communityfirstrealestate.com.au/rent/"
    ...
    count = 1
    db = 'CommunityFirst'
    collection = 'CommunityFirst_Rent'
    ...
    def __init__(self, *args, **kwargs):
        super(CommunityFirst_Rent, self).__init__(*args, **kwargs)
        self.links = []
