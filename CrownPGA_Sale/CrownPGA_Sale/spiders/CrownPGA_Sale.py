...
class CrownPGA_Sale(scrapy.Spider):
    name = "CrownPGA_Sale"

    url = "https://home.crownpga.com.au/buying/residential-properties-for-sale#"
    ...
    def __init__(self, *args, **kwargs):
        super(CrownPGA_Sale, self).__init__(*args, **kwargs)
        self.links = []
