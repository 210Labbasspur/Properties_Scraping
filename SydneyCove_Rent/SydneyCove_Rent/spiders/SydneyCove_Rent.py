...
class SydneyCove_Rent(scrapy.Spider):
    name = 'SydneyCove_Rent'
    prefix = 'https://www.sydneycoveproperty.com'
    url = 'https://www.sydneycoveproperty.com/wp-admin/admin-ajax.php'
    headers = {
        'accept': '*/*',
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Sydney Cove Property'
