...
class MotionProperty_Sold(scrapy.Spider):
    name = "MotionProperty_Sold"

    url = "https://motionproperty.com.au/property/?_status=sold"
    ...
    count = 1
    db = 'MotionProperty'
    collection = 'MotionProperty_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(MotionProperty_Sold, self).__init__(*args, **kwargs)
        self.links = []
