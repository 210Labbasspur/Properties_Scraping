...
class MyProperty_Rent(scrapy.Spider):
    name = 'MyProperty_Rent'
    prefix = 'https://www.mypropertyepping.com.au'
    url = "https://www.mypropertyepping.com.au/renting/properties-for-lease/"
    headers = {
