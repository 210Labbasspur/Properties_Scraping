...
class Belize_Sale(scrapy.Spider):
    name = "Belize_Sale"

    url = "https://www.belizeproperty.com.au/buying/current-properties"
    ...
    def __init__(self, *args, **kwargs):
        super(Belize_Sale, self).__init__(*args, **kwargs)
        self.links = []
