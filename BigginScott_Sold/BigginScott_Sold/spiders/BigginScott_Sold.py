...
class BigginScott_Sold(scrapy.Spider):
    name = "BigginScott_Sold"

    url = 'https://bigginscott.com.au/propertiesJson?callback=angular.callbacks._2&currentPage={}&perPage=96&sort=d_sold%20desc&listing_cat0=residential&listing_cat1=commercial&listing_cat2=business&web_stage=sold'
    ...
    def __init__(self, *args, **kwargs):
        super(BigginScott_Sold, self).__init__(*args, **kwargs)
        self.links = []
