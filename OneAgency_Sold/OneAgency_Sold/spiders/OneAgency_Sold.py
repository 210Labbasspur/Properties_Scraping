...
class OneAgency_Sold(scrapy.Spider):
    name = 'OneAgency_Sold'
    prefix = 'https://oneagencyforest.com.au'
    url = "https://oneagencyforest.com.au/listings/?saleOrRental=Sale&status=sold&sortby=saleDate-desc"
    headers = {
    ...
    count = 1
    db = 'OneAgency'
    collection = 'OneAgency_Sold'
    bucket_prefix = 'D_OneAgency_Sold'
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            if sold_price:
                item['Field9'] = (sold_price.strip()).replace('$','')   # full_adddress
