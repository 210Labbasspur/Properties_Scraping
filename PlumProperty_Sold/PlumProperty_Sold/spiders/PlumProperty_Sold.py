...
class PlumProperty_Sold(scrapy.Spider):
    name = "PlumProperty_Sold"
    ...
    def __init__(self, *args, **kwargs):
        super(PlumProperty_Sold, self).__init__(*args, **kwargs)
        self.links = []
