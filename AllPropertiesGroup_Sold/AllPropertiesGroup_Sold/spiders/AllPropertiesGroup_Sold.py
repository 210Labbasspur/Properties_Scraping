...
class AllPropertiesGroup_Sold(scrapy.Spider):
    name = "AllPropertiesGroup_Sold"

    url = "https://allpropertiesgroup.com.au/sold/"
    ...
    collection = 'AllPropertiesGroup_Sold'
    ...
    def __init__(self, *args, **kwargs):
        super(AllPropertiesGroup_Sold, self).__init__(*args, **kwargs)
        self.links = []
