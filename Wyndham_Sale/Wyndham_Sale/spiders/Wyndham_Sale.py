...
class Wyndham_Sale(scrapy.Spider):
    name = "Wyndham_Sale"

    url = "https://wyndhamre.com.au/search/?show_in_sale=true&sold=0"
    ...
    def __init__(self, *args, **kwargs):
        super(Wyndham_Sale, self).__init__(*args, **kwargs)
        self.links = []
