...
class Xynergy_Rent(scrapy.Spider):
    name = "Xynergy_Rent"

    url = "https://www.xynergy.com.au/for-lease/properties-for-lease/"
    ...
    def __init__(self, *args, **kwargs):
        super(Xynergy_Rent, self).__init__(*args, **kwargs)
        self.links = []
