...
class ByronShire_Rent(scrapy.Spider):
    name = 'ByronShire_Rent'
    prefix = 'https://www.byronshirerealestate.com.au'
    url = "https://www.byronshirerealestate.com.au/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=rental"
    headers = {
        'accept': '*/*',
