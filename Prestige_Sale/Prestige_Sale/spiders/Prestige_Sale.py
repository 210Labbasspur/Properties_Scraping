...
class Prestige_Sale(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):
        super(Prestige_Sale, self).__init__(*args, **kwargs)
        self.links = []
