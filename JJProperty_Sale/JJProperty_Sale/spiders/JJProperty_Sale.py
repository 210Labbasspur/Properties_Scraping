...
class JJProperty_Sale(scrapy.Spider):
    name = "JJProperty_Sale"

    url = "https://www.jjproperty.com.au/pages/real-estate/results?widgetKey=266319&context=listings&returnAs=markup&listing_sale_method=sale&display_sale_method=Sale&status=sale&pg=1"
    ...
    def __init__(self, *args, **kwargs):
        super(JJProperty_Sale, self).__init__(*args, **kwargs)
        self.links = []
