...
class ChrisWilsonRE_Sale(scrapy.Spider):
    name = 'ChrisWilsonRE_Sale'
    prefix = 'https://www.chriswilsonrealestateeden.com.au'
    url = "https://www.chriswilsonrealestateeden.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=residential"
    headers = {
        'accept': '*/*',
    ...
    def Detail_parse(self, mini_data,full_data):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Chris Wilson Real Estate'
