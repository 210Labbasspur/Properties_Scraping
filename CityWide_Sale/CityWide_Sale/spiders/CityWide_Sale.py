...
class CityWide_Sale(scrapy.Spider):
    name = 'CityWide_Sale'
    prefix = 'https://www.citywidecommercial.com.au'
    url = "https://www.citywidecommercial.com.au/buy/residential/"
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'cache-control': 'max-age=0',
        # 'cookie': 'PHPSESSID=g3pjhcpfrnudiealeq8r9l438r; PHPSESSID=g3pjhcpfrnudiealeq8r9l438r; _ga=GA1.1.2131987107.1713265574; _ga_TCGBQ7FSMG=GS1.1.1713265573.1.1.1713265732.0.0.0; arp_scroll_position=0; PHPSESSID=g3pjhcpfrnudiealeq8r9l438r',
    ...
    def parse(self, response):
        for property in response.css("a.item")[:2]:
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'CityWide Commercial'

            property_add = response.css('.property-address h1 ::text').getall()  # full_adddress
            ...
            # sold_price = response.css('.property-address span ::text').get('').strip().replace(' ','')
            # if sold_price:
            ...
            agent1_name = agent1.xpath("//*[contains(text(),'Name.')]/parent::span[1]/text()").get('').strip()
            if agent1:
                ...
                agent1_phone = agent1.xpath("//*[contains(text(),'Mobile.')]/parent::span[1]/text()").get('').strip()
            ...
            if len(response.css("div.agent").getall()) > 1:
                ...
                agent2_name = agent2.xpath("//*[contains(text(),'Name.')]/parent::span[1]/text()").get('').strip()
                if agent2:
                    ...
                    agent2_phone = agent2.xpath("//*[contains(text(),'Mobile.')]/parent::span[1]/text()").get('').strip()
            ...
            if len(response.css("div.agent").getall()) == 3:
                ...
                agent3_name = agent3.xpath("//*[contains(text(),'Name.')]/parent::span[1]/text()").get('').strip()
                if agent3:
                    ...
                    agent3_phone = agent3.xpath("//*[contains(text(),'Mobile.')]/parent::span[1]/text()").get('').strip()
