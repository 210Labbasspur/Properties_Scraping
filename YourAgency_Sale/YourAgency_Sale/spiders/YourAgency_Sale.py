...
class YourAgency_Sale(scrapy.Spider):
    name = 'YourAgency_Sale'
    prefix = 'https://www.youragency.net.au'
    url = 'https://www.youragency.net.au/wp-admin/admin-ajax.php'
    headers = {
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
        # 'cookie': '_ga=GA1.1.1627431385.1713706440; _ga_GKXT5CTN5Q=GS1.1.1713965960.3.0.1713965964.0.0.0; arp_scroll_position=5483',
        'origin': 'https://www.youragency.net.au',
        'priority': 'u=1, i',
        # 'referer': 'https://www.youragency.net.au/sell/sold/',
    ...
    data = {
        'atts[list]': 'sale',
        'atts[multilist]': '',        'atts[layout]': '',        'atts[sur_suburbs_radius]': '10',
        ...
        'atts[sur_suburbs]': '0',        'atts[center_latlng]': '',        'atts[max_page]': 'false',
        ...
        'atts[auth]': '0',        'atts[auth_type]': 'content',        'atts[sort]': 'sold_date_desc',
        'atts[auth_message]': 'Sorry, You Are Not Allowed to Access This Page',        'atts[include_private_listing]': '0',
        'atts[map_attribute_loadCallback]': 'ap_realty.searchResultsMapCallback',        'atts[load_more_automatic]': 'true',
        'per_page': '18',        'load_more': 'true',        'selectorMap': '#map_canvas',
        'selector': '#ap-listing-search-results',        'sort': 'sold_date_desc',        'action': 'property_search_results',
        'current_page': '',
    }
    count = 1
    db = 'YourAgency'
    collection = 'YourAgency_Sale'
