...
class TheoPoulos_Rent(scrapy.Spider):
    name = 'TheoPoulos_Rent'
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Theo Poulos Real Estate'
