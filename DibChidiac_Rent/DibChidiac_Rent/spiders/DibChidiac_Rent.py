...
class DibChidiac_Rent(scrapy.Spider):
    name = 'DibChidiac_Rent'
    prefix = 'https://dibchidiac.com.au'
    url = "https://dibchidiac.com.au/properties-for-lease"
    headers = {
        'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'Accept-Language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'Cache-Control': 'max-age=0',
        'Connection': 'keep-alive',
        # 'Cookie': '_gcl_au=1.1.1039374347.1713705525; hubspotutk=0af99867b778eb3ca80826e41ed7744a; _gid=GA1.3.954994335.1714077038; ProtoCID=rfK-VilO5534ezxxoqMVn1; _ga_R6S402TL1F=GS1.1.1714125916.5.0.1714125916.0.0.0; _ga=GA1.3.1988559532.1713705527; _gat_gtag_UA_100084845_11=1; __hstc=13600168.0af99867b778eb3ca80826e41ed7744a.1713705798323.1714082404073.1714125916692.4; __hssrc=1; __hssc=13600168.1.1714125916692; arp_scroll_position=3356',
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            # sold_price = response.css('p .muted ::text').get('').strip().replace(' ','')
            # if sold_price:
            ...
            if response.css(".agentTile"):
                ...
                if agent1:
                    ...
                    '''         Uploading Images on Wasabi S3 Bucket            '''
                    Agent_Images = self.prefix + agent1.css(".image img ::attr(src)").get('').strip()
                ...
                if len(response.css(".agentTile").getall()) > 1:
                    ...
                    if agent2:
                        ...
                        '''         Uploading Images on Wasabi S3 Bucket            '''
                        Agent_Images = self.prefix + agent2.css(".image img ::attr(src)").get('').strip()
                ...
                if len(response.css(".agentTile").getall()) == 3:
                    ...
                    if agent3:
                        ...
                        '''         Uploading Images on Wasabi S3 Bucket            '''
                        Agent_Images = self.prefix + agent3.css(".image img ::attr(src)").get('').strip()
