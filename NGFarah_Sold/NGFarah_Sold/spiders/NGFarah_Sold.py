...
class NGFarah_Sold(scrapy.Spider):
    name = 'NGFarah_Sold'
    prefix = 'https://www.ngfarah.com.au'
    url = "https://www.ngfarah.com.au/sold-properties"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            bed_bath_car = response.xpath("//h2[contains(text(),'Sold')]/following-sibling::div[contains(@class,'icons')]/text()").getall()
