...
class AMRUTTY_Rent(scrapy.Spider):
    name = 'AMRUTTY_Rent'
    prefix = 'https://www.amrutty.com.au'
    url = "https://www.amrutty.com.au/rent/residential-for-rent/"
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'cache-control': 'max-age=0',
        # 'cookie': '_ga=GA1.1.934462618.1713700520; _ga_S0DLE7TR2V=GS1.1.1714216486.8.1.1714216705.0.0.0; arp_scroll_position=591',
        'priority': 'u=0, i',
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'AMRUTTY Coastal Estate Agents'
