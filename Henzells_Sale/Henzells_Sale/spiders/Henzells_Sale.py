...
class Henzells_Sale(scrapy.Spider):
    name = "Henzells_Sale"

    url = "https://henzells.com.au/buying/property-for-sale"
    ...
    def __init__(self, *args, **kwargs):
        super(Henzells_Sale, self).__init__(*args, **kwargs)
        self.links = []
