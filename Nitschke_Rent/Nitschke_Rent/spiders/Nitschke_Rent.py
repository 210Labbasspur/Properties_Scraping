...
class Nitschke_Rent(scrapy.Spider):
    name = "Nitschke_Rent"

    url = "https://www.nitschke.com.au/properties-for-rent/"
    ...
    def __init__(self, *args, **kwargs):
        super(Nitschke_Rent, self).__init__(*args, **kwargs)
        self.links = []
