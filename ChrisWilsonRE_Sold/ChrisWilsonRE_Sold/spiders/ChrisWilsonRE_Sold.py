...
class ChrisWilsonRE_Sold(scrapy.Spider):
    name = 'ChrisWilsonRE_Sold'
    prefix = 'https://www.chriswilsonrealestateeden.com.au'
    url = "https://www.chriswilsonrealestateeden.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold"
    headers = {
        'accept': '*/*',
