...
class AreaSpecialist_Sold(scrapy.Spider):
    name = 'AreaSpecialist_Sold'
    prefix = 'https://www.areaspecialist.com.au'
    url = ("https://www.areaspecialist.com.au/pages/real-estate/results?widgetKey=224993&context=listings&returnAs=markup&listing_sale_method=sale&"
           "status=sold&pg={}")
    headers = {
    ...
    count = 1
    db = 'AreaSpecialist'
    collection = 'AreaSpecialist_Sold'
