...
class Guardian_Rent(scrapy.Spider):
    name = 'Guardian_Rent'
    prefix = 'https://www.guardianrealty.com.au'
    url = 'https://www.guardianrealty.com.au/wp-admin/admin-ajax.php'
    headers = {
        'accept': '*/*',
