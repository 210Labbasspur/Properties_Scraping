################333             DegreesRealEstateRockBank_Sale
...
class DegreesRealEstateRockBank_Sale(scrapy.Spider):
    name = "DegreesRealEstateRockBank_Sale"

    url = "https://www.361degreesrealestaterockbank.com.au/buy/"
    ...
    collection = 'DegreesRealEstateRockBank_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(DegreesRealEstateRockBank_Sale, self).__init__(*args, **kwargs)
        self.links = []
