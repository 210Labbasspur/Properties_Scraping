...
class TheAvenue_Sale(scrapy.Spider):
    name = 'TheAvenue_Sale'
    prefix = 'https://www.theavenuerealestate.com.au'
    url = 'https://www.theavenuerealestate.com.au/wp-admin/admin-ajax.php'
    headers = {
        'accept': '*/*',
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'The Avenue Real Estate'
