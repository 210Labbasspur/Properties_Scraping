...
class Jensen_Sale(scrapy.Spider):
    name = "Jensen_Sale"
    url = ('https://www.jensenproperty.com.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bcount%5D%5Bvalue%5D=20&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Bmeta_key%5D%5Bvalue%5D=dateListed&query%5Bsold%5D%5Bvalue%5D=0&query%5BsaleOrRental%5D%5Bvalue%5D=Sale&query%5Bdoing_wp_cron%5D%5Bvalue%5D=1737606635.8222670555114746093750&query%5Bdoing_wp_cron%5D%5Btype%5D=equal&query'
    ...
    def __init__(self, *args, **kwargs):
        super(Jensen_Sale, self).__init__(*args, **kwargs)
        self.links = []
