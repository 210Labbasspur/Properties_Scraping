...
class Oneill_Sold(scrapy.Spider):
    name = "Oneill_Sold"

    url = "https://www.byronyoneill.com.au/properties-sold/"
    prefix = "https://www.byronyoneill.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(Oneill_Sold, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(3247)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Byrony Oneill Estate Agents'

            property_street = response.css('.entry-title ::text').get('').strip()  # property_street
            ...
            prop_images = response.css(".et_pb_gallery_image a ::attr(href)").getall()
            images = []
