...
class DavidMurphy_Sale(scrapy.Spider):
    name = "DavidMurphy_Sale"

    url = "https://www.davidmurphy.com.au/buying"
    ...
    def __init__(self, *args, **kwargs):
        super(DavidMurphy_Sale, self).__init__(*args, **kwargs)
        self.links = []
