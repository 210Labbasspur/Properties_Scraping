...
class PPD_Rent(scrapy.Spider):
    name = 'PPD_Rent'
    prefix = 'https://www.ppdre.com.au'
    url = ("https://www.ppdre.com.au/wp-admin/admin-ajax.php?id=properties_search&post_id=15&slug=for-lease&canonical_url=https%3A%2F%2Fwww.ppdre.com.au%2Fproperties%2Ffor-lease%2F&posts_per_page=80&"
           "page={}"
           "&offset=0&post_type=properties&repeater=default&seo_start_page=1&preloaded=false&preloaded_amount=0&taxonomy=listing-type:listing-status&taxonomy_terms=lease:current&taxonomy_operator=IN:IN&order=DESC&orderby=modified&custom_args=kw:;suburbs:;streets:;features-bedrooms:;features-bathrooms:;features-carports:;price:;rent:;layout:;&action=alm_get_posts&query_type=standard")
