...
class Hood_Sale(scrapy.Spider):
    name = "Hood_Sale"

    url = "https://hoodestateagents.com.au/ajaxPublish?_s_=Results&_f_=ForSale-Search-V2&n=9&page={}"
    ...
    def __init__(self, *args, **kwargs):
        super(Hood_Sale, self).__init__(*args, **kwargs)
        self.links = []
