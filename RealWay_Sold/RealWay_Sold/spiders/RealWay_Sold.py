...
class RealWay_Sold(scrapy.Spider):
    name = "RealWay_Sold"
    url = "https://toowoomba.realway.com.au/listings?saleOrRental=Sale&sold=1"
    ...
    def __init__(self, *args, **kwargs):
        super(RealWay_Sold, self).__init__(*args, **kwargs)
        self.links = []
