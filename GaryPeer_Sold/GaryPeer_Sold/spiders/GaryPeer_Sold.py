...
class GaryPeer_Sold(scrapy.Spider):
    name = "GaryPeer_Sold"

    url = "https://www.garypeer.com.au/sell/recent-sales?page={}&listing_type=1&add_status=0"
    ...
    def __init__(self, *args, **kwargs):
        super(GaryPeer_Sold, self).__init__(*args, **kwargs)
        self.links = []
