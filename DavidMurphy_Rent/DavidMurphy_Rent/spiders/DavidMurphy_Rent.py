...
class DavidMurphy_Rent(scrapy.Spider):
    name = "DavidMurphy_Rent"

    url = "https://www.davidmurphy.com.au/renting"
    ...
    def __init__(self, *args, **kwargs):
        super(DavidMurphy_Rent, self).__init__(*args, **kwargs)
        self.links = []
