...
class Bells_Rent(scrapy.Spider):
    name = "Bells_Rent"
    url = 'https://www.bellsrealestate.com.au/data/results/?listing_category=residential&listing_sale_method=Lease&gallery=1&pg={}'
    ...
    def __init__(self, *args, **kwargs):
        super(Bells_Rent, self).__init__(*args, **kwargs)
        self.links = []
