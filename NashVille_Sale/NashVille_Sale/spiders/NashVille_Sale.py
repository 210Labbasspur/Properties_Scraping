...
class NashVille_Sale(scrapy.Spider):
    name = "NashVille_Sale"
    url = 'https://www.nashvilleproperty.com.au/ajax/residential-proprties.php?data%5Bpage%5D={}&data%5Bstatus%5D=current&data%5BsaleOrLease%5D=SALE'
    ...
    def __init__(self, *args, **kwargs):
        super(NashVille_Sale, self).__init__(*args, **kwargs)
        self.links = []
