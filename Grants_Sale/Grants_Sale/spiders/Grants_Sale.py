...
class Grants_Sale(scrapy.Spider):
    name = "Grants_Sale"

    url = "https://www.grantsea.com.au/?action=epl_search&post_type=property&property_status=current"
    ...
    def __init__(self, *args, **kwargs):
        super(Grants_Sale, self).__init__(*args, **kwargs)
        self.links = []
