...
class Brookes_Rent(scrapy.Spider):
    name = 'Brookes_Rent'
    prefix = 'https://www.brookes.net.au'
    url = "https://www.brookes.net.au/renting/residential-for-lease/"
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'cache-control': 'max-age=0',
        # 'cookie': '_ga=GA1.1.1603768136.1712709842; arp_scroll_position=300; _ga_Q6D4XWDP0K=GS1.1.1712709841.1.1.1712709914.0.0.0',
