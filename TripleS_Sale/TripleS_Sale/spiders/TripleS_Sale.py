...
class TripleS_Sale(scrapy.Spider):
    name = 'TripleS_Sale'
    prefix = 'https://triplesproperty.com.au'
    url = "https://triplesproperty.com.au/properties-for-sale"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            type = ''
            bed_bath_car = response.xpath("//*[contains(@class,'icons hide-med')]/text()").getall()
            if len(bed_bath_car) > 1:
                item['Field6'] = ''.join(re.findall(r'\d+', bed_bath_car[1].strip()))
                type = bed_bath_car[-1].strip()
