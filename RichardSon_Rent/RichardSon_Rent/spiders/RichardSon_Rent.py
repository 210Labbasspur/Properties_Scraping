...
class RichardSon_Rent(scrapy.Spider):
    name = "RichardSon_Rent"

    url = "https://www.richardsonpg.com.au/buying/properties-for-lease/"
    ...
    count = 1
    db = 'RichardSon'
    collection = 'RichardSon_Rent'
    bucket_prefix = f'RSPG_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(RichardSon_Rent, self).__init__(*args, **kwargs)
        self.links = []
