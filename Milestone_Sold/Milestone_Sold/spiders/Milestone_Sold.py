...
class Milestone_Sold(scrapy.Spider):
    name = "Milestone_Sold"

    url = "https://www.milestonere.com.au/recently-sold/"
    ...
    def __init__(self, *args, **kwargs):
        super(Milestone_Sold, self).__init__(*args, **kwargs)
        self.links = []
