...
class Como_Rent(scrapy.Spider):
    name = "Como_Rent"

    url = "https://www.comoreal.estate/lease"
    prefix = "https://www.comoreal.estate"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(Como_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(3034)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Como Real Estate'
            ...
            '''          AGENTS          '''
            item['Field15'] = 'Arthur'
            item['Field16'] = 'Dislakis'
            item['Field17'] = 'Arthur Dislakis'
            item['Field20'] = '0412731175'
            images_string = 'https://s3.ap-southeast-1.wasabisys.com/Images8_1/411624535_1.jpg'
