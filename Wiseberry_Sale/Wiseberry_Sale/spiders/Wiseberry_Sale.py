...
class Wiseberry_Sale(scrapy.Spider):
    name = "Wiseberry_Sale"

    url = "https://wiseberry.com.au/buy?page=buy?&page={}&limit=9"
    ...
    def __init__(self, *args, **kwargs):
        super(Wiseberry_Sale, self).__init__(*args, **kwargs)
        self.links = []
