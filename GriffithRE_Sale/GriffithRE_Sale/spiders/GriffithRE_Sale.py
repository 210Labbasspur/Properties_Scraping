...
class GriffithRE_Sale(scrapy.Spider):
    name = "GriffithRE_Sale"

    url = ('https://www.griffithre.com/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bpost_type%5D%5Btype%5D=equal&query%5Bcount%5D%5Bvalue%5D=20&query%5Bcount%5D%5Btype%5D=equal&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Borderby%5D%5Btype%5D=equal&query%5Bmeta_key%5D%5Bvalue%5D=dateListed&query%5Bmeta_key%5D%5Btype%5D=equal&query%5Bsold%5D%5Bvalue%5D=0&query%5Bsold%5D%5Btype%5D=equal&query%5BsaleOrRental%5D%5Bvalue%5D=Sale&query%5BsaleOrRental%5D%5Btype%5D=equal&query'
           '%5Bpaged%5D%5Bvalue%5D={}&query%5Bpaged%5D%5Btype%5D=equal&query%5Bdoing_wp_cron%5D%5Bvalue%5D=1737080906.4048840999603271484375&query%5Bdoing_wp_cron%5D%5Btype%5D=equal')
    ...
    def __init__(self, *args, **kwargs):
        super(GriffithRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
