...
class Abercrombys_Rent(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):
        super(Abercrombys_Rent, self).__init__(*args, **kwargs)
        self.links = []
