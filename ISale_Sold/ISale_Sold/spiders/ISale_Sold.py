...
class ISale_Sold(scrapy.Spider):
    name = 'ISale_Sold'
    prefix = 'https://www.isaleproperty.net.au'
    url = 'https://www.isaleproperty.net.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(ISale_Sold, self).__init__(*args, **kwargs)
        self.links = []
