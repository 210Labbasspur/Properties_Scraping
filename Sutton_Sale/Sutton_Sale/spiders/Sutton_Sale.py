...
class Sutton_Sale(scrapy.Spider):
    name = "Sutton_Sale"

    url = "https://www.suttonnationwiderealty.com.au/buy/for-sale/page/{}/"
    ...
    def __init__(self, *args, **kwargs):
        super(Sutton_Sale, self).__init__(*args, **kwargs)
        self.links = []
