...
class Global_Sale(scrapy.Spider):
    name = 'Global_Sale'
    prefix = 'https://www.globalproperty.net.au'
    # url = ("https://www.globalproperty.net.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bpost_type%5D%5Btype%5D=equal&query%5Bcount%5D%5Bvalue%5D=20&query%5Bcount%5D%5Btype%5D=equal&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Borderby%5D%5Btype%5D=equal&query%5Bmeta_key%5D%5Bvalue%5D=saleDate&query%5Bmeta_key%5D%5Btype%5D=equal&query%5Bsold%5D%5Bvalue%5D=0&query%5Bsold%5D%5Btype%5D=equal&query%5BsaleOrRental%5D%5Bvalue%5D=Sale&query%5BsaleOrRental%5D%5Btype%5D=equal&query"
    #        "%5Bpaged%5D%5Bvalue%5D=1&query%5Bpaged%5D%5Btype%5D=equal&query%5Bextended%5D%5Bvalue%5D=1&query%5Bextended%5D%5Btype%5D=equal")
    url = ("https://www.globalproperty.net.au/wp-admin/admin-ajax.php?action=get_posts&query%5Bpost_type%5D%5Bvalue%5D=listings&query%5Bpost_type%5D%5Btype%5D=equal&query%5Bcount%5D%5Bvalue%5D=20&query%5Bcount%5D%5Btype%5D=equal&query%5Borderby%5D%5Bvalue%5D=meta_value&query%5Borderby%5D%5Btype%5D=equal&query%5Bmeta_key%5D%5Bvalue%5D=saleDate&query%5Bmeta_key%5D%5Btype%5D=equal&query%5Bsold%5D%5Bvalue%5D=0&query%5Bsold%5D%5Btype%5D=equal&query%5BsaleOrRental%5D%5Bvalue%5D=Sale&query%5BsaleOrRental%5D%5Btype%5D=equal&query"
           "%5Bpaged%5D%5Bvalue%5D={}&query%5Bpaged%5D%5Btype%5D=equal&query%5Bextended%5D%5Bvalue%5D=1&query%5Bextended%5D%5Btype%5D=equal")
    headers = {
        'accept': '*/*',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'content-length': '0',
        # 'cookie': '_gid=GA1.3.1602949927.1713442723; __eventn_id=dd5hn83xkb; _gcl_au=1.1.711900188.1713442724; _gat=1; _ga=GA1.1.656171871.1713442723; _ga_LJ3QB6FX5S=GS1.1.1713523173.2.1.1713523211.0.0.0; _ga_67P859NBLX=GS1.3.1713523173.2.1.1713523211.22.0.0',
        'origin': 'https://www.globalproperty.net.au',
        'priority': 'u=1, i',
        # 'referer': 'https://www.globalproperty.net.au/listings/?saleOrRental=Sale&sold=1',
