...
class Denovans_Sold(scrapy.Spider):
    name = "Denovans_Sold"
    url = 'https://denovans.com.au/wp-json/api/listings/all?suburbsSurrounding=&priceRange=&category=&type=property&status=sold&paged={}&limit=16&address=&bed=&bath=&car=&sort='
    ...
    def __init__(self, *args, **kwargs):
        super(Denovans_Sold, self).__init__(*args, **kwargs)
        self.links = []
