...
class ThePropertyShop_Rent(scrapy.Spider):
    name = 'ThePropertyShop_Rent'
    prefix = 'https://www.thepropertyshop.com.au'
    url = "https://www.thepropertyshop.com.au/renting/residential/"
    headers = {
    ...
    count = 1
    db = 'ThePropertyShop'
    collection = 'ThePropertyShop_Rent'
