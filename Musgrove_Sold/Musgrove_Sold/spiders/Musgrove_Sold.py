...
class Musgrove_Sold(scrapy.Spider):
    name = 'Musgrove_Sold'
    prefix = 'https://www.musgroverealty.com.au'
    url = "https://www.musgroverealty.com.au/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold"
    headers = {
        'accept': '*/*',
