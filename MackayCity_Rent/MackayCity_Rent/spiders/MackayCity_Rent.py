...
class MackayCity_Rent(scrapy.Spider):
    name = "MackayCity_Rent"

    url = "https://mackaycityproperty.com.au/current-rental-listings-in-mackay/"
    ...
    def __init__(self, *args, **kwargs):
        super(MackayCity_Rent, self).__init__(*args, **kwargs)
        self.links = []
