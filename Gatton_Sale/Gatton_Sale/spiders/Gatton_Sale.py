...
class Gatton_Sale(scrapy.Spider):
    name = "Gatton_Sale"
    url = "https://gattonrealestate.com.au/listings?viewType=gallery&sortby=dateListed-desc&saleOrRental=Sale&type=residential&status=available_under_contract"
    ...
    def __init__(self, *args, **kwargs):
        super(Gatton_Sale, self).__init__(*args, **kwargs)
        self.links = []
