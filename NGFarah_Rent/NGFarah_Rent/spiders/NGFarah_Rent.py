...
class NGFarah_Rent(scrapy.Spider):
    name = 'NGFarah_Rent'
    prefix = 'https://www.ngfarah.com.au'
    url = "https://www.ngfarah.com.au/properties-for-lease"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            bed_bath_car = response.xpath("//h2[contains(text(),'For Lease')]/following-sibling::div[contains(@class,'icons')]/text()").getall()
