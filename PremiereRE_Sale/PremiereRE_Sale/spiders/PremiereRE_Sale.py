...
class PremiereRE_Sale(scrapy.Spider):
    name = "PremiereRE_Sale"

    url = "https://www.premiererealestate.com.au/pages/real-estate/results?widgetKey=80768&context=listings&returnAs=markup&listing_sale_method=sale&listing_category=&status=buy&listing_suburb_search=&listing_price_from=&listing_price_to=&listing_bedrooms=&listing_bathrooms=&surrounds=&staff_id=&pg=1"
    ...
    def __init__(self, *args, **kwargs):
        super(PremiereRE_Sale, self).__init__(*args, **kwargs)
        self.links = []
