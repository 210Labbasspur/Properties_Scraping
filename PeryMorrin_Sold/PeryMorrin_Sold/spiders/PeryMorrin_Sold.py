...
class PeryMorrin_Sold(scrapy.Spider):
    name = "PeryMorrin_Sold"

    url = "https://perymorrinproperty.com/sold/page/1/"
    ...
    count = 1
    db = 'PeryMorrin'
    collection = 'PeryMorrin_Sold'
    bucket_prefix = f'PM_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(PeryMorrin_Sold, self).__init__(*args, **kwargs)
        self.links = []
