...
class HockingStuart_Sale(scrapy.Spider):
    name = 'HockingStuart_Sale'
    prefix = 'https://hockingstuart.com.au'
    url = "https://hockingstuart.com.au/listings?propertyType=residential&sort=newold&searchStatus=buy&surr=1&state=all"
    headers = {
