...
class Lara_Rent(scrapy.Spider):
    name = "Lara_Rent"

    url = "https://larare.com.au/properties-for-lease/?action=epl_search&post_type=rental&property_status=current"
    ...
    count = 1
    db = 'Lara'
    collection = 'Lara_Rent'
    bucket_prefix = f'LRE_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(Lara_Rent, self).__init__(*args, **kwargs)
        self.links = []
