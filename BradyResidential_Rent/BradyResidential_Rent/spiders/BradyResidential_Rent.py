...
class BradyResidential_Rent(scrapy.Spider):
    name = "BradyResidential_Rent"

    url = "https://www.bradyresidential.com.au/rent/search-rentals/"
    ...
    count = 1
    db = 'BradyResidential'
    collection = 'BradyResidential_Rent'
    bucket_prefix = f'BR_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(BradyResidential_Rent, self).__init__(*args, **kwargs)
        self.links = []
