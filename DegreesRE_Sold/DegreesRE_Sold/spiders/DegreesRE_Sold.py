...
class DegreesRE_Sold(scrapy.Spider):
    name = "DegreesRE_Sold"

    url = "https://www.361realestate.com.au/properties/?category=&property_status=sold&bedrooms=0&bathrooms=0&cars=&min_price=&max_price=&suburb="
    ...
    def __init__(self, *args, **kwargs):
        super(DegreesRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
