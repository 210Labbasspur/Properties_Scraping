...
class JanJones_Sold(scrapy.Spider):
    name = 'JanJones_Sold'
    prefix = 'https://www.janjones.com.au'
    url = 'https://www.janjones.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_sold%20desc&web_stage=sold'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(JanJones_Sold, self).__init__(*args, **kwargs)
        self.links = []
