...
class ChisholmGamon_Sale(scrapy.Spider):
    name = "ChisholmGamon_Sale"

    url = "https://chisholmgamon.com.au/real-estate-for-sale/property-buy?page={}"
    ...
    def __init__(self, *args, **kwargs):
        super(ChisholmGamon_Sale, self).__init__(*args, **kwargs)
        self.links = []
