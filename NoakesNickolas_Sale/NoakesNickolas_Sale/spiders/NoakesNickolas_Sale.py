...
class NoakesNickolas_Sale(scrapy.Spider):
    name = "NoakesNickolas_Sale"

    url = "https://noakesnickolas.com.au/listings/"
    ...
    count = 1
    db = 'NoakesNickolas'
    collection = 'NoakesNickolas_Sale'
    ...
    def __init__(self, *args, **kwargs):
        super(NoakesNickolas_Sale, self).__init__(*args, **kwargs)
        self.links = []
