...
class RichardSon_Sold(scrapy.Spider):
    name = "RichardSon_Sold"

    url = "https://www.richardsonpg.com.au/selling/recent-sales/"
    ...
    count = 1
    db = 'RichardSon'
    collection = 'RichardSon_Sold'
    bucket_prefix = f'RSPG_{collection}'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(RichardSon_Sold, self).__init__(*args, **kwargs)
        self.links = []
