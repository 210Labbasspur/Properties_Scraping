...
class BuyMyPlace_Sale(scrapy.Spider):
    name = "BuyMyPlace_Sale"

    url = "https://buymyplace.com.au/buy-property/listings/Australia/anyPropertyTypes/anyMinPrice/anyMaxPrice/anyMinBeds/anyMinBaths/surround/12/0"
    ...
    count = 1
    db = 'BuyMyPlace'
    collection = 'BuyMyPlace_Sale'
    bucket_prefix = f'Images1'

    local_file_path = '/img'

    def __init__(self, *args, **kwargs):
        super(BuyMyPlace_Sale, self).__init__(*args, **kwargs)
        self.links = []
