...
class FirstNational_Sale(scrapy.Spider):
    name = 'FirstNational_Sale'
    prefix = 'https://www.clk.com.au'
    url = "https://www.clk.com.au/pages/real-estate/results?widgetKey=191129&context=listings&returnAs=markup&listing_sale_method=sale&pg={}"
    headers = {
