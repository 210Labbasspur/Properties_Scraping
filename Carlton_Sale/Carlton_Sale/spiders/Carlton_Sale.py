...
class Carlton_Sale(scrapy.Spider):
    name = 'Carlton_Sale'
    prefix = 'https://www.carltonrealestate.com.au'
    url = 'https://www.carltonrealestate.com.au/wp-admin/admin-ajax.php'
    headers = {
        'accept': '*/*',
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Carlton Real Estate'
            ...
            Agent_Imagess = response.xpath("//*[contains(@class,'embed-responsive-16by9')]/picture/source/img/@src").getall()
            new_img_urls = []
