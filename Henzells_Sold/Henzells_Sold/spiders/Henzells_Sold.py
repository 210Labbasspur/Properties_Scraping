...
class Henzells_Sold(scrapy.Spider):
    name = "Henzells_Sold"

    url = "https://henzells.com.au/sell/recent-sales/page-1"
    ...
    def __init__(self, *args, **kwargs):
        super(Henzells_Sold, self).__init__(*args, **kwargs)
        self.links = []
