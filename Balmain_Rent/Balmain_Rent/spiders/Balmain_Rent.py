...
class Balmain_Rent(scrapy.Spider):
    name = 'Balmain_Rent'
    prefix = 'https://www.balmainrealty.com'
    url = "https://www.balmainrealty.com/renting/properties-for-lease/"
    headers = {
