...
class ISale_Rent(scrapy.Spider):
    name = 'ISale_Rent'
    prefix = 'https://www.isaleproperty.net.au'
    url = 'https://www.isaleproperty.net.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=rental'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(ISale_Rent, self).__init__(*args, **kwargs)
        self.links = []
