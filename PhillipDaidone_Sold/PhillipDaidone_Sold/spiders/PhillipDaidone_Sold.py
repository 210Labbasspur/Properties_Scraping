...
class PhillipDaidone_Sold(scrapy.Spider):
    name = 'PhillipDaidone_Sold'
    prefix = 'https://www.phillipdaidone.com.au'
    url = 'https://www.phillipdaidone.com.au/wp-admin/admin-ajax.php'
    headers = {
        'accept': '*/*',
    ...
    count = 1
    db = 'PhillipDaidone'
    collection = 'PhillipDaidone_Sold'
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            item['Field4'] = 'Phillip Daidone Realty'
            ...
            if response.css(".listing-agent"):
                ...
                if agent1:
                    ...
                    item['Field19'] = agent1.css(".email ::text").get('').strip().replace('E:','')  # description
                    agent1_phone = agent1.css(".mobile ::text").get('').strip().replace('M:','')  # description
                    item['Field20'] = agent1_phone.strip()  # description
                    agent1_mobile = agent1.css(".phone ::text").get('').strip().replace('P:','')  # description
                ...
                if len(response.css(".listing-agent").getall()) > 1:
                    ...
                    if agent2:
                        ...
                        item['Field25'] = agent2.css(".email ::text").get('').strip().replace('E:', '')  # description
                        agent2_phone = agent2.css(".mobile ::text").get('').strip().replace('M:', '')  # description
                        item['Field26'] = agent2_phone.strip()  # description
                        agent2_mobile = agent2.css(".phone ::text").get('').strip().replace('P:', '')  # description
                ...
                if len(response.css(".listing-agent").getall()) > 2:
                    ...
                    if agent3:
                        ...
                        item['Field30'] = agent3.css(".email ::text").get('').strip().replace('E:', '')  # description
                        agent3_phone = agent3.css(".mobile ::text").get('').strip().replace('M:', '')  # description
                        item['Field31'] = agent3_phone.strip()  # description
                        agent3_mobile = agent3.css(".phone ::text").get('').strip().replace('P:', '')  # description
            ...
            feature_count = 58
            for feature in response.css(".col-md-6"):
