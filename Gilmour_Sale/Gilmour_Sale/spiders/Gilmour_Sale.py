...
class Gilmour_Sale(scrapy.Spider):
    name = 'Gilmour_Sale'
    prefix = 'https://www.gilmour.com.au'
    url = "https://www.gilmour.com.au/buying/properties-for-sale/"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            Agent_Imagess = response.css('.img-default-used-size-hd ::attr(src)').getall()
            new_img_urls = []
