...
class Gerard_Rent(scrapy.Spider):
    name = 'Gerard_Rent'
    prefix = 'https://www.gerardpartners.com.au'
    url = "https://www.gerardpartners.com.au/renting/properties-for-lease/"
    headers = {
        'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
        'accept-language': 'en-US,en;q=0.9,ur;q=0.8,nl;q=0.7',
        'cache-control': 'max-age=0',
        # 'cookie': '_ga=GA1.1.381933440.1713705053; arp_scroll_position=400; _ga_1DTQ6FJN4W=GS1.1.1713708183.2.1.1713708319.0.0.0; _ga_VYVV2N2ZW8=GS1.1.1713708181.2.1.1713708320.0.0.0',
        'priority': 'u=0, i',
