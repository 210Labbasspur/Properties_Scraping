...
class OneAgency_Rent(scrapy.Spider):
    name = 'OneAgency_Rent'
    prefix = 'https://oneagencyforest.com.au'
    url = "https://oneagencyforest.com.au/listings?saleOrRental=Rental&status=available_under_contract&sortby=dateListed-desc"
    headers = {
    ...
    count = 1
    db = 'OneAgency'
    collection = 'OneAgency_Rent'
    bucket_prefix = 'D_OneAgency_Rent'
