...
class SouthWestPC_Rent(scrapy.Spider):
    name = 'SouthWestPC_Rent'
    prefix = 'https://www.southwestpropertycentre.com.au'
    url = "https://www.southwestpropertycentre.com.au/properties-for-rent"
    headers = {
    ...
    def parse(self, response):
        for property in response.css("#properties_display_subpage a"):#[:2]:
