...
class Gatton_Rent(scrapy.Spider):
    name = "Gatton_Rent"
    url = "https://gattonrealestate.com.au/listings?viewType=gallery&sortby=dateListed-desc&saleOrRental=Rental&type=residential&status=available_under_contract"
    prefix = "https://gattonrealestate.com.au"
    headers = {
    ...
    def __init__(self, *args, **kwargs):
        super(Gatton_Rent, self).__init__(*args, **kwargs)
        self.links = []
    ...
    def parse(self, response):
        ...
        for each_url in all_links:
            each_url = f'https://gattonrealestate.com.au{each_url}'
        ...
        for property_url in all_links:
            property_url = f'https://gattonrealestate.com.au{property_url}'
    ...
    def detail_parse(self, response):
        ...
        if detail_page_url not in database_sale_matching_url:
            item = dict()
            item['Field1'] = ''
            item['Field2'] = int(2079)
            item['Field3'] = datetime.now().date().strftime('%Y-%m-%d')  # date_data_scanned
            item['Field4'] = 'Gatton Real Estate'
