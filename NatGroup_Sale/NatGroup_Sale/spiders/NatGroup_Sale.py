...
class NatGroup_Sale(scrapy.Spider):
    name = "NatGroup_Sale"

    url = "https://www.natgroup.net/queensland-real-estate-agents"
    ...
    def __init__(self, *args, **kwargs):
        super(NatGroup_Sale, self).__init__(*args, **kwargs)
        self.links = []
