...
class WhiteRhino_Sold(scrapy.Spider):
    name = 'WhiteRhino_Sold'
    prefix = 'https://www.whiterhinoproperty.com.au'
    url = "https://www.whiterhinoproperty.com.au/selling/recent-sales/"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            sold_price = response.css('.suburb-price ::text').get('').strip().replace('SOLD OFF-MARKET','').replace(' ','')
