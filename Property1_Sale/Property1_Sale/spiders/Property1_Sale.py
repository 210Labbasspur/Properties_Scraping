...
class Property1_Sale(scrapy.Spider):
    name = 'Property1_Sale'
    prefix = 'https://www.property1group.com.au'
    url = "https://www.property1group.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=residential"
    headers = {
        'accept': '*/*',
