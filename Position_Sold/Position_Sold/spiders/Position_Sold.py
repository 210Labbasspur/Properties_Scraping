...
class Position_Sold(scrapy.Spider):
    name = "Position_Sold"

    url = "https://www.positionproperty.com.au/selling/recent-sales"
    ...
    def __init__(self, *args, **kwargs):
        super(Position_Sold, self).__init__(*args, **kwargs)
        self.links = []
