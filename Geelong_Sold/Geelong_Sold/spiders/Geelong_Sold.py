...
class Geelong_Sold(scrapy.Spider):
    name = "Geelong_Sold"

    url = "https://www.geelongrealestate.co/property-category/for-sale/page/1/"
    ...
    def __init__(self, *args, **kwargs):
        super(Geelong_Sold, self).__init__(*args, **kwargs)
        self.links = []
