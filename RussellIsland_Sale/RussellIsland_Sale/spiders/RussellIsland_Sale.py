...
class RussellIsland_Sale(scrapy.Spider):
    name = 'RussellIsland_Sale'
    prefix = 'https://www.russellislandrealestate.com.au'
    url = 'https://www.russellislandrealestate.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat=residential'
    headers = {
        'accept': '*/*',
    ...
    def __init__(self, *args, **kwargs):
        super(RussellIsland_Sale, self).__init__(*args, **kwargs)
        self.links = []
