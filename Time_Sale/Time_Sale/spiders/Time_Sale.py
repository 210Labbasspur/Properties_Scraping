...
class Time_Sale(scrapy.Spider):
    name = 'Time_Sale'
    prefix = 'https://www.timerealty.com.au'
    pre_url = 'https://www.timerealty.com.au/buy/search-property/'
    url = ("https://www.timerealty.com.au/wp-content/plugins/zoorealty/display/elements/load_listings.php?status=1,4&list=sale&order=&order_direction=&"
