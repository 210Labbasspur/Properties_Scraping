...
class ClarkeCo_Sale(scrapy.Spider):
    name = 'ClarkeCo_Sale'
    prefix = 'https://presence.realestate'
    # url = ('https://www.clarkeandco.com.au/wp-json/api/listings/all?status=current&type=property&'
    #        'paged=1&priceRange=&isProject=false&limit=8&author=&bed=0&bath=0&sort=')
    url = ('https://www.clarkeandco.com.au/wp-json/api/listings/all?status=current&type=property&'
