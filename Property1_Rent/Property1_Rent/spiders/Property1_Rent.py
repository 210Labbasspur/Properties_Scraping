...
class Property1_Rent(scrapy.Spider):
    name = 'Property1_Rent'
    prefix = 'https://www.property1group.com.au'
    url = "https://www.property1group.com.au/propertiesJson?callback=angular.callbacks._0&currentPage={}&perPage=12&sort=d_listing%20desc&listing_cat0=rental"
    headers = {
        'accept': '*/*',
