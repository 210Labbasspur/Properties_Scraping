...
class Coastal_Rent(scrapy.Spider):
    name = "Coastal_Rent"
    url = 'https://www.coastal.com.au/wp-json/api/listings/all?priceRange=&landArea=&floorArea=&limit=12&type=rental&status=current&address=&paged={}&bed=&bath=&car=&sort='
    ...
    def __init__(self, *args, **kwargs):
        super(Coastal_Rent, self).__init__(*args, **kwargs)
        self.links = []
