...
class CoreRealty_Sale(scrapy.Spider):
    name = "CoreRealty_Sale"

    url = "https://corerealty.com.au/buy/"
    ...
    def __init__(self, *args, **kwargs):
        super(CoreRealty_Sale, self).__init__(*args, **kwargs)
        self.links = []
