...
class ParkesRealProperty_Sale(scrapy.Spider):
    name = 'ParkesRealProperty_Sale'
    prefix = 'https://www.parkesrealproperty.com.au'
    url = "https://www.parkesrealproperty.com.au/properties/"
    headers = {
    ...
    collection = 'ParkesRealProperty_Sale'
