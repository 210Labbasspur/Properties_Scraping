...
class Unique_Property_Sold(scrapy.Spider):
    name = 'Unique_Property_Sold'
    prefix = 'https://www.unique-property.com'
    url = "https://www.unique-property.com/selling/recent-sales/"
    headers = {
    ...
    count = 1
    db = 'Unique_Property'
    collection = 'Unique_Property_Sold'
    bucket_prefix = 'D_Unique_Property_Sold'
