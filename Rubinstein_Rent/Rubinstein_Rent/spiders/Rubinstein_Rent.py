...
class Rubinstein_Rent(scrapy.Spider):
    name = 'Rubinstein_Rent'
    prefix = 'https://www.therubinsteingroup.com'
    url = 'https://www.therubinsteingroup.com/lease/'
    headers = {
    ...
    def start_requests(self):
        ...
        driver.get('https://www.therubinsteingroup.com/lease/')
        time.sleep(2)
