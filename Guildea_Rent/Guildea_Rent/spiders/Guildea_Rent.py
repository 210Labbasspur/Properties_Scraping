...
class Guildea_Rent(scrapy.Spider):
    name = 'Guildea_Rent'
    prefix = 'https://guildea.com.au'
    url = "https://guildea.com.au/properties-for-lease"
    headers = {
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            # sold_price = response.xpath("//div[contains(@class,'muted')]/text()").get('').strip()
