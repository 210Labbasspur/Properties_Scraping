...
class Altitude_Sale(scrapy.Spider):
    name = 'Altitude_Sale'
    prefix = 'https://www.altituderealestate.com.au'
    url = ("https://www.altituderealestate.com.au/data/results/?listing_category=residential&listing_sale_method=Sale&"
           "sort=date-desc&pg={}")
    headers = {
        'accept': '*/*',
    ...
    count = 1
    db = 'Altitude'
    collection = 'Altitude_Sale'
    bucket_prefix = f'D_{collection}'

    def start_requests(self):
        yield scrapy.Request(url='https://www.altituderealestate.com.au/residential/sale', callback=self.parse, headers=self.headers)
