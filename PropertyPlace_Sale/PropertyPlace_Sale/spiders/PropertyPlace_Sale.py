...
class PropertyPlace_Sale(scrapy.Spider):
    name = "PropertyPlace_Sale"

    url = "https://propertyplace.agency/real-estate/buy-residential-properties/"
    ...
    def __init__(self, *args, **kwargs):
        super(PropertyPlace_Sale, self).__init__(*args, **kwargs)
        self.links = []
