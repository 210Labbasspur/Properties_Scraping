...
class Queensland_Sold(scrapy.Spider):
    name = "Queensland_Sold"

    url = "https://queenslandsothebysrealty.com/sold-properties"
    ...
    def __init__(self, *args, **kwargs):
        super(Queensland_Sold, self).__init__(*args, **kwargs)
        self.links = []
