...
class LSProperties_Sale(scrapy.Spider):
    name = 'LSProperties_Sale'
    prefix = 'https://www.lsproperties.com.au'
    url = 'https://www.lsproperties.com.au/wp-admin/admin-ajax.php'
    headers = {
        'accept': '*/*',
    ...
    data = {
        ...
        'atts[sort]': '-properties.price,-properties.id',
        'per_page': '6',
        'load_more': 'true',
        'selectorMap': '#map_canvas',
        'selector': '#ap-listing-search-results',
        'current_page': '2',
        'sort': '-properties.price,-properties.id',
        'action': 'property_search_results',
    }

    count = 1
    db = 'LSProperties'
    collection = 'LSProperties_Sale'
