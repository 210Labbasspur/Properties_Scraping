...
class GreenPark_Sale(scrapy.Spider):
    name = 'GreenPark_Sale'
    prefix = 'https://www.greenparkrealty.com.au'
    url = "https://www.greenparkrealty.com.au/show-all-properties"
    headers = {
    ...
    def parse(self, response):
        for property in response.css(".col-md-5 a"):
    ...
    def Detail_parse(self, response):
        ...
        if not DB_already_exists:
            ...
            if response.xpath("//*[contains(text(),'Garage')]/following-sibling::span[1]/text()").get('').strip():
                item['Field8'] = response.xpath("//*[contains(text(),'Garage')]/following-sibling::span[1]/text()").get('').strip()
            elif response.xpath("//*[contains(text(),'Car Space')]/following-sibling::span[1]/text()").get('').strip():
                item['Field8'] = response.xpath("//*[contains(text(),'Car Spaces')]/following-sibling::span[1]/text()").get('').strip()
            ...
            # Agent_Imagess = response.xpath("//*[contains(@class,'slider-image')]/div/picture/source/img/@src").getall()
            ...
            if response.css(".widget-title+ div"):
                ...
                agent1_name = agent1.xpath(".//a[contains(@href,'meet-the-team')]/text()").get('').strip()
                if agent1_name:
                    ...
                    agent1_phones = agent1.xpath(".//a[contains(@href,'tel:')]/@href").getall()
                    if len(agent1_phones) > 1:
                        agent1_mobile = agent1_phones[-1].strip().replace('tel:','')
                ...
                if len(response.css(".widget-title+ div").getall()) > 1:
                    ...
                    agent2_name = agent2.xpath(".//a[contains(@href,'meet-the-team')]/text()").get('').strip()
                    if agent2:
                        ...
                        agent2_phones = agent2.xpath(".//a[contains(@href,'tel:')]/@href").getall()
                        if len(agent2_phones) > 1:
                            item['Field26A'] = agent2_phones[-1].strip().replace('tel:', '')
                        '''         Uploading Images on Wasabi S3 Bucket            '''
                ...
                if len(response.css(".widget-title+ div").getall()) > 2:
                    ...
                    agent3_name = agent3.xpath(".//a[contains(@href,'meet-the-team')]/text()").get('').strip()
                    if agent3:
                        ...
                        agent3_phones = agent3.xpath(".//a[contains(@href,'tel:')]/@href").getall()
                        if len(agent3_phones) > 1:
                            item['Field31A'] = agent3_phones[-1].strip().replace('tel:', '')
                        '''         Uploading Images on Wasabi S3 Bucket            '''
