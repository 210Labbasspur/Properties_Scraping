...
class Abercrombys_Sold(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):
        super(Abercrombys_Sold, self).__init__(*args, **kwargs)
        self.links = []
