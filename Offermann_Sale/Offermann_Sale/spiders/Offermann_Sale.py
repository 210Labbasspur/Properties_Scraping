...
class Offermann_Sale(scrapy.Spider):
    name = "Offermann_Sale"
    url = 'https://www.offermann.com.au/propertiesJson?callback=angular.callbacks._1&currentPage={}&perPage=12&sort=dt_created%20desc&listing_cat0=residential'
    ...
    def __init__(self, *args, **kwargs):
        super(Offermann_Sale, self).__init__(*args, **kwargs)
        self.links = []
