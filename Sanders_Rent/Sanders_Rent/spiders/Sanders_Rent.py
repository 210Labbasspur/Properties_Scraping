...
class Sanders_Rent(scrapy.Spider):
    name = 'Sanders_Rent'
    prefix = 'https://www.sanders.com.au'
    url = "https://www.sanders.com.au/rent/new-listings/?pg={}&sort=&agent="
    headers = {
    ...
    def parse(self, response):
        ...
        all_details_links = []
        for url in response.css(".img-loading a"):
        ...
        '''  #######   Original Code   #######  '''
        for property in response.css(".img-loading a"):
        ...
        next_page = response.xpath("//*[contains(text(),'Show more')]").get('').strip()
        if next_page:
