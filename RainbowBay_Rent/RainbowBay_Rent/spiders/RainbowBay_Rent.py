...
class RainbowBay_Rent(scrapy.Spider):
    name = "RainbowBay_Rent"

    url = 'https://www.rainbowbayrealty.com.au/lease/residential-properties'
    ...
    def __init__(self, *args, **kwargs):
        super(RainbowBay_Rent, self).__init__(*args, **kwargs)
        self.links = []
