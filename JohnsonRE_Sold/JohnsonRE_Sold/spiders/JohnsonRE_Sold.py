...
class JohnsonRE_Sold(scrapy.Spider):
    name = "JohnsonRE_Sold"

    url = "https://www.johnsonre.com.au/sold-properties?203695f3_page=1"
    ...
    def __init__(self, *args, **kwargs):
        super(JohnsonRE_Sold, self).__init__(*args, **kwargs)
        self.links = []
